    ...
    await sendEmail({
      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto;">
          ...
          <a href="${resetUrl}" style="display: inline-block; background: #C25572; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px; margin: 16px 0;">
            Reset Password
          </a>
    ...
    await sendEmail({
      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto;">
          ...
          <a href="${verifyUrl}" style="display: inline-block; background: #C25572; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px; margin: 16px 0;">
            Verify Email
          </a>
        </div>
      `,
