...
const PROMPT_VERSION = 'v5'; // v5 (2026-07-21): narrow melt — v4's wide dissolve + top veil "made the whole page dark and unattractive" (Paul); the dark ends in a ≤200px melt and the image stays bright
