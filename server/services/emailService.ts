  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto;">
        ...
        <a href="${acceptUrl}" style="display: inline-block; background: #BA3C60; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px; margin: 16px 0;">
          Accept Invitation
        </a>
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto;">
        ...
        <a href="${passUrl}" style="display: inline-block; background: #BA3C60; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px; margin: 16px 0;">
          Activate Day Pass
        </a>
        <p style="color: #A9A49C; font-size: 12px; margin-top: 24px;">
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto;">
        ...
        <a href="${BASE_URL}/chat" style="display: inline-block; background: #BA3C60; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px; margin: 16px 0;">
          View Matches
        </a>
        <p style="color: #A9A49C; font-size: 12px; margin-top: 24px;">
