...
const workstreams: DefinitiveSubstrateWorkstream[] = [
  ...
  },
  {
    ...
    mcpTools: ['compose_data_room_index', 'compose_document_draft', 'prepare_rwi_submission', 'prepare_negotiation_brief', 'generate_funds_flow', 'prepare_regulatory_filings', 'compose_pmi_plan'],
