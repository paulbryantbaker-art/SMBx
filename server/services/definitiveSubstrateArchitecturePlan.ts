...
const phases: DefinitiveSubstratePhase[] = [
  ...
  },
  {
    ...
    outputs: ['definition of done by classification', 'RWI submission deliverable', 'negotiation brief deliverable', 'close readiness packet', 'funds flow deliverable', 'PMI plan deliverable', 'introspect_capabilities', 'next_suggested_calls envelope'],
  },
  {
    id: 'Phase 5',
    window: 'Weeks 35+',
