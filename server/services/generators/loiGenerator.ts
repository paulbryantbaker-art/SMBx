...
export interface LOIInput {
  ...
  deal_structure:
    | 'asset' | 'stock' | 'hybrid'
    // Merger Lite (B4.5) — extended structures. Full §368 reorg analysis
    // lands in Phase 5; this enum lets the LOI pick the right section
    // template + label without that depth.
...
/** Pretty label for the deal_structure enum (B4.5 added merger structures). */
