...
function primaryPacketKey(toolName: string): string | null {
  return ({
    ...
    generate_permutations: 'paretoFrontier',
    score_permutation: 'permutation',
    set_objective_preference: 'paretoFrontier',
    compute_best_vehicle: 'bestVehicleBlock',
    expand_permutations: 'paretoFrontier',
...
function packetTypeForTool(toolName: string) {
  return ({
    ...
    generate_permutations: 'ParetoFrontier.v0.1',
    score_permutation: 'StructurePermutation.v0.1',
    set_objective_preference: 'ParetoFrontier.v0.1',
    compute_best_vehicle: 'BestVehicleBlock.v0.1',
    expand_permutations: 'ParetoFrontier.v0.1',
