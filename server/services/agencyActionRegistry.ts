...
const CONTRACTS: Record<string, AgencyActionContract> = {
  ...
  get_deal_state: {
    ...
    label: 'Read persisted deal state',
    methodologyRefs: ['DEFINITIVE DealState', 'DEFINITIVE Deal OS lifecycle', 'DEFINITIVE portable take-back artifacts'],
    mode: 'read',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['deal-state:read'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Read the latest persisted DealState snapshot by deal, conversation, or CID so an agent can resume the recursive Deal OS loop.',
  },
  assess_deal_entry: {
    toolName: 'assess_deal_entry',
    label: 'Assess agent deal entry',
    methodologyRefs: ['DEFINITIVE Deal OS lifecycle', 'DEFINITIVE CapabilityCatalog', 'The Diligence Standard'],
    mode: 'navigator',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['capability:read', 'methodology:read', 'deal-plan:read'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Assess where an agent is entering the deal lifecycle from partial facts, EV-only context, artifacts, or DealState and return the exact next tool sequence.',
  },
  introspect_capabilities: {
    toolName: 'introspect_capabilities',
    label: 'Introspect agent capabilities',
    methodologyRefs: ['DEFINITIVE CapabilityCatalog', 'DEFINITIVE Deal OS lifecycle', 'The Diligence Standard'],
    mode: 'navigator',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['capability:read', 'methodology:read'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Return contextual capability, lifecycle, work-surface, model-mechanics, and next-call guidance so an agent can enter the Deal OS without guessing.',
  },
  describe_methodology: {
    toolName: 'describe_methodology',
    label: 'Describe The Diligence Standard',
    methodologyRefs: ['DEFINITIVE methodology', 'The Diligence Standard', 'THE LINE'],
    mode: 'read',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['methodology:read', 'authority:read'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Return version-pinned methodology, lifecycle, model-catalog, schema, authority, conformance, and THE LINE guidance for agents and humans.',
  },
  estimate_deal_cost: {
    toolName: 'estimate_deal_cost',
    label: 'Estimate deal workspace cost',
    methodologyRefs: ['DEFINITIVE pricing doctrine', 'THE LINE', 'Pass-Through Substrate Catalog'],
    mode: 'auditor',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['pricing:read', 'pass-through:read'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Explain monthly workspace fit and software/data pass-through posture without wallets, success fees, deal-value fees, or paid human-service referrals.',
  },
  get_deal_runbook: {
    toolName: 'get_deal_runbook',
    label: 'Read Deal OS runbook',
    methodologyRefs: ['DEFINITIVE Deal OS lifecycle', 'The Diligence Standard', 'DEFINITIVE RunbookSurface'],
    mode: 'navigator',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['methodology:read', 'deal-plan:read'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Return the journey-specific runbook that tells agents how to work the entire deal lifecycle recursively instead of stopping at a single model call.',
  },
  lookup_model_slot: {
    toolName: 'lookup_model_slot',
    label: 'Look up DEFINITIVE model slot',
    methodologyRefs: ['DEFINITIVE M101-M223', 'The Diligence Standard', 'DEFINITIVE route map'],
    mode: 'read',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['methodology:read', 'model-catalog:read'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Return route, gate, authority, runtime-model, surface, and THE LINE metadata for a stable M101-M223 model slot.',
  },
  compose_deal_plan: {
  ...
  clone_deal_state: {
    ...
    label: 'Clone deal state',
    methodologyRefs: ['DEFINITIVE DealState', 'DEFINITIVE recursive work loop', 'DEFINITIVE portable take-back artifacts'],
    mode: 'coordinator',
    permissionLevel: 'A2_INTERNAL_WRITE',
    riskLevel: 'internal_write',
    confirmation: 'none',
    writeScope: 'deal',
    requiredScopes: ['deal-state:read', 'deal-state:write'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Clone a DealState into a new content-addressed revision for scenario work or parallel agent review while preserving parent CID lineage.',
  },
  ...
  verify_package: {
    ...
    label: 'Verify deal package',
    methodologyRefs: ['DEFINITIVE DealPackage', 'DEFINITIVE PackageVerification', 'DEFINITIVE THE LINE'],
    mode: 'auditor',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['deal-package:read', 'deal-package:verify'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Verify a portable DealPackage content address, companion DealState reference, take-back artifacts, recursive next calls, and THE LINE invariant without making any closing or professional determination.',
  },
  finalize_deal_package: {
    toolName: 'finalize_deal_package',
    label: 'Finalize deal package',
    methodologyRefs: ['DEFINITIVE DealPackage', 'DEFINITIVE AuditPacket', 'DEFINITIVE SignedManifest', 'DEFINITIVE MerkleInclusionProof'],
    mode: 'auditor',
    permissionLevel: 'A2_INTERNAL_WRITE',
    riskLevel: 'internal_write',
    confirmation: 'none',
  ...
  reopen_deal_package: {
    ...
    label: 'Reopen deal package',
    methodologyRefs: ['DEFINITIVE DealPackage', 'DEFINITIVE DealState', 'DEFINITIVE recursive Deal OS lifecycle'],
    mode: 'coordinator',
    permissionLevel: 'A2_INTERNAL_WRITE',
    riskLevel: 'internal_write',
    confirmation: 'none',
    writeScope: 'deal',
    requiredScopes: ['deal-package:read', 'deal-state:write'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Reopen a prior package into a new DealState revision when new information arrives, preserving lineage and recursive next calls.',
  },
  generate_permutations: {
    toolName: 'generate_permutations',
    label: 'Generate structure permutations',
    methodologyRefs: ['DEFINITIVE StructurePermutation', 'DEFINITIVE ParetoFrontier', 'DEFINITIVE THE LINE'],
    mode: 'modeler',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['deal-state:read', 'permutation:read'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Generate deterministic deal-structure permutations and a Pareto frontier without recommending a structure.',
  },
  score_permutation: {
    toolName: 'score_permutation',
    label: 'Score structure permutation',
    methodologyRefs: ['DEFINITIVE StructurePermutation', 'DEFINITIVE ModelOutput'],
    mode: 'modeler',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    ...
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Score a single structure under caller-stated preferences; output is computation-only.',
  },
  set_objective_preference: {
    toolName: 'set_objective_preference',
    label: 'Set objective preference',
    methodologyRefs: ['DEFINITIVE ParetoFrontier', 'DEFINITIVE preference-vector scoring'],
    mode: 'modeler',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    ...
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Set caller preferences for deterministic structure comparison without making a recommendation.',
  },
  compute_best_vehicle: {
    toolName: 'compute_best_vehicle',
    label: 'Compute best vehicle',
    methodologyRefs: ['DEFINITIVE BestVehicleBlock', 'DEFINITIVE ParetoFrontier', 'DEFINITIVE THE LINE'],
    mode: 'modeler',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    ...
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Compute the highest-scoring vehicle under supplied preferences; this is not advice or a recommendation.',
  },
  expand_permutations: {
    toolName: 'expand_permutations',
    label: 'Expand structure permutations',
    methodologyRefs: ['DEFINITIVE StructurePermutation', 'DEFINITIVE ParetoFrontier'],
    mode: 'modeler',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    ...
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Expand the structure comparison set with overlay variants for a broader computed frontier.',
  },
  resume_deal: {
  ...
  compose_lifecycle_trace: {
    ...
    label: 'Compose lifecycle trace',
    methodologyRefs: ['DEFINITIVE LifecycleTrace', 'DEFINITIVE Deal OS lifecycle', 'DEFINITIVE DealState'],
    mode: 'navigator',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    ...
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Return a portable lifecycle trace of stage history, events, artifacts, blockers, and next calls so humans or agents can keep the iterative deal loop synchronized.',
  },
  prepare_ioi_packet: {
    toolName: 'prepare_ioi_packet',
    label: 'Prepare IOI packet',
    methodologyRefs: ['DEFINITIVE IOIPacket', 'DEFINITIVE Deal OS lifecycle', 'DEFINITIVE Studio surface'],
    mode: 'author',
    permissionLevel: 'A3_GENERATE_WORK_PRODUCT',
    riskLevel: 'internal_write',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['deal-state:read', 'studio:draft', 'model-stack:compose'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'required',
    description: 'Organize known facts, preliminary economics, source gaps, and model dependencies for IOI work. It does not make or send an offer.',
  },
  prepare_loi_packet: {
    toolName: 'prepare_loi_packet',
    label: 'Prepare LOI packet',
    methodologyRefs: ['DEFINITIVE LOIPacket', 'DEFINITIVE agreement mechanics', 'DEFINITIVE Deal OS lifecycle'],
    mode: 'author',
    permissionLevel: 'A3_GENERATE_WORK_PRODUCT',
    riskLevel: 'internal_write',
    confirmation: 'none',
    ...
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'required',
    description: 'Organize LOI structure, economic terms, closing conditions, source gaps, model dependencies, and counsel handoffs. It does not draft clauses, make a binding offer, negotiate, or transmit externally.',
  },
  ...
  prepare_diligence_request: {
    ...
    label: 'Prepare diligence request',
    methodologyRefs: ['DEFINITIVE DiligenceRequest', 'DEFINITIVE DataRoomIndex', 'DEFINITIVE Deal OS lifecycle'],
    mode: 'author',
    permissionLevel: 'A3_GENERATE_WORK_PRODUCT',
    riskLevel: 'internal_write',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['deal-state:read', 'data-room:read', 'studio:draft'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'required',
    description: 'Organize source-backed diligence asks, missing inputs, model dependencies, and THE LINE handoffs. It does not send requests externally or make legal demands.',
  },
  disclose_subset: {
  ...
  prepare_negotiation_brief: {
    ...
    label: 'Prepare negotiation brief',
    methodologyRefs: ['DEFINITIVE NegotiationBrief', 'DEFINITIVE agreement mechanics', 'DEFINITIVE Deal OS lifecycle'],
    mode: 'author',
    permissionLevel: 'A3_GENERATE_WORK_PRODUCT',
    riskLevel: 'internal_write',
    confirmation: 'none',
    ...
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'required',
    description: 'Organize open terms, source gaps, model-backed range status, and THE LINE handoffs for negotiation prep. It does not negotiate or recommend concessions.',
  },
  compose_close_readiness: {
    toolName: 'compose_close_readiness',
    label: 'Compose close readiness',
    methodologyRefs: ['DEFINITIVE CloseReadiness', 'DEFINITIVE closing mechanics', 'DEFINITIVE Deal OS lifecycle'],
    mode: 'auditor',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['deal-state:read', 'completeness:read', 'deal-package:read'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'required',
    description: 'Organize close-readiness checks, blockers, approvals, source gaps, model dependencies, and next calls. It does not authorize closing, move money, issue wires, or transmit externally.',
  },
  generate_funds_flow: {
    toolName: 'generate_funds_flow',
    label: 'Generate funds flow',
    methodologyRefs: ['DEFINITIVE FundsFlow', 'DEFINITIVE closing mechanics', 'DEFINITIVE Deal OS lifecycle'],
    mode: 'author',
    permissionLevel: 'A3_GENERATE_WORK_PRODUCT',
    riskLevel: 'internal_write',
    confirmation: 'none',
    ...
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'required',
    description: 'Organize closing sources, uses, adjustments, reconciliation, and handoffs. It does not move money, issue wire instructions, act as escrow agent, or authorize closing.',
  },
  compose_pmi_plan: {
    toolName: 'compose_pmi_plan',
    label: 'Compose PMI plan',
    methodologyRefs: ['DEFINITIVE PMIPlan', 'DEFINITIVE Deal OS lifecycle', 'MODEL.PMI.VALUE.CREATION.v1'],
    mode: 'author',
    permissionLevel: 'A3_GENERATE_WORK_PRODUCT',
    riskLevel: 'internal_write',
    confirmation: 'none',
    ...
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'required',
    description: 'Organize post-close Day 0, stabilization, assessment, optimization, source gaps, model dependencies, and risk tracking. It does not make operating decisions or provide employment/legal/tax advice.',
  },
  ...
  run_model_iteration: {
    ...
    label: 'Run model iteration',
    methodologyRefs: ['DEFINITIVE ModelOutput', 'DEFINITIVE iterative model canvas', 'V19 server-side model runtime'],
    mode: 'modeler',
    permissionLevel: 'A3_GENERATE_WORK_PRODUCT',
    riskLevel: 'internal_write',
    confirmation: 'none',
    writeScope: 'model',
    requiredScopes: ['model:execute', 'audit:write', 'model:read'],
    billing: { eventType: 'model_run', creditCost: 1, billable: true, unit: 'run' },
    citationRequirement: 'required',
    description: 'Run a first deterministic model pass or rerun a saved execution with parent-output lineage, missing inputs, hashes, citations, and next calls for iterative deal work.',
  },
  list_model_executions: {
    toolName: 'list_model_executions',
    label: 'List model executions',
    methodologyRefs: ['DEFINITIVE ModelOutput', 'DEFINITIVE iterative model canvas', 'V19 audit records'],
    mode: 'modeler',
    permissionLevel: 'A0_READ',
    riskLevel: 'safe',
    confirmation: 'none',
    writeScope: 'none',
    requiredScopes: ['model:read', 'deal:read'],
    billing: { eventType: 'external_agent_api_call', creditCost: 0, billable: false, unit: 'api_call' },
    citationRequirement: 'optional',
    description: 'Read persisted model executions, model canvas versions, output hashes, parent-output lineage, dependency contracts, freshness/rerun status, and take-back envelopes so humans and agents can continue iterative deal modeling without rerunning blindly.',
  },
  generate_output_doc: {
    toolName: 'generate_output_doc',
    label: 'Generate output document',
    methodologyRefs: ['DEFINITIVE DocumentDraft', 'DEFINITIVE Studio surface', 'DEFINITIVE deal lifecycle'],
    mode: 'author',
    permissionLevel: 'A3_GENERATE_WORK_PRODUCT',
    riskLevel: 'internal_write',
    confirmation: 'none',
    writeScope: 'deliverable',
    requiredScopes: ['deal-state:read', 'studio:draft', 'model:read'],
    billing: { eventType: 'document_generation', creditCost: 1, billable: true, unit: 'document' },
    citationRequirement: 'required',
    description: 'Generate an internal work product by agent-friendly document type, resolving internal deliverable routes and preserving model-dependency context. External export remains a separate approval action.',
  },
  lookup_citation: {
