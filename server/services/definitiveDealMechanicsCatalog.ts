...
export const DEFINITIVE_DEAL_MECHANICS_CATALOG: DefinitiveModelCatalogEntry[] = [
  ...
  entry('M148', 'Three-prong solvency', 'v1_0_core', 'professional_handoff', ['G15', 'G28', 'G29'], ['recap', 'LBO', 'fraudulent transfer'], ['11 U.S.C. 548', 'UVTA', 'Tribune'], 'Balance-sheet, cash-flow, and capital-adequacy tests at user inputs.'),
  ...
  entry('M151', '363 asset sale mechanics', 'v1_0_core', 'professional_handoff', ['G28'], ['distressed sale', '363 sale'], ['11 U.S.C. 363', '11 U.S.C. 365', 'RadLAX', 'Fisker'], 'Sale timeline, bid-protection cost, free-and-clear prongs, and credit-bid eligibility.'),
  entry('M152', 'Plan feasibility', 'v1_0_core', 'professional_handoff', ['G28'], ['Chapter 11 plan'], ['11 U.S.C. 1129(a)(11)'], 'Cash flow, DSCR, liquidity, covenant, and EBITDA-sensitivity table.'),
  entry('M153', 'Best-interests-of-creditors', 'v1_0_core', 'professional_handoff', ['G28'], ['Chapter 11 plan'], ['11 U.S.C. 1129(a)(7)', '11 U.S.C. 726'], 'Per-class plan recovery versus hypothetical Chapter 7 recovery.'),
  entry('M154', 'Absolute priority rule and new value', 'v1_0_core', 'professional_handoff', ['G28'], ['Chapter 11 cramdown'], ['11 U.S.C. 1129(b)', '203 N. LaSalle', 'Castleton Plaza'], 'Priority waterfall and new-value decision tree.'),
  entry('M155', 'Cramdown interest rate', 'v1_0_core', 'professional_handoff', ['G28'], ['Chapter 11 cramdown'], ['Till', 'MPM Silicones', 'Texas Grand Prairie', 'Topp'], 'Efficient-market/Till formula range and circuit flag.'),
  entry('M156', '1111(b) election trade-off', 'v1_0_core', 'professional_handoff', ['G28'], ['undersecured Chapter 11 creditor'], ['11 U.S.C. 1111(b)'], 'Election eligibility and no-election versus election value comparison.'),
  entry('M157', '726 Chapter 7 waterfall', 'v1_0_core', 'deterministic', ['G28'], ['Chapter 7', 'liquidation analysis'], ['11 U.S.C. 507', '11 U.S.C. 726'], 'Distribution by statutory priority and trustee-fee schedule.'),
  entry('M158', '364 DIP sizing', 'v1_0_core', 'professional_handoff', ['G28', 'G29'], ['DIP financing'], ['11 U.S.C. 364', 'Collier 364.06'], '13-week cash, minimum liquidity, roll-up, carve-out, and priming schedule.'),
  entry('M159', 'Fulcrum security', 'v1_1', 'professional_handoff', ['G28'], ['distressed-for-control'], ['market practice'], 'Enterprise value through capital stack and recovery by tranche.'),
  entry('M160', 'Exchange offer and distressed-debt exchange', 'v1_0_core', 'professional_handoff', ['G29'], ['out-of-court restructuring'], ['Securities Act 3(a)(9)', 'TIA 316(b)'], 'Participation threshold, holdout economics, and CODI exposure.'),
  ...
  entry('M164', 'RSA economics', 'v1_1', 'professional_handoff', ['G28', 'G29'], ['restructuring support agreement'], ['11 U.S.C. 1125', 'Indianapolis Downs'], 'Class support, milestones, termination, fiduciary-out, and toggle schedule.'),
  entry('M165', 'ABC and Article 9 foreclosure recovery', 'v1_0_core', 'professional_handoff', ['G28'], ['out-of-court liquidation'], ['UCC 9-610', 'UCC 9-611', 'UCC 9-615', 'state ABC law'], 'Notice, sale, waterfall, assignee fee, and recovery schedule.'),
  entry('M166', 'Claims trading recovery', 'v1_0_core', 'deterministic', ['G28'], ['claims trading'], ['Moody\'s Ultimate Recovery Database', 'FRBP 3001'], 'Claim-purchase IRR and ultimate-recovery regression.'),
  entry('M167', 'Subchapter V eligibility', 'v1_0_core', 'deterministic', ['G28'], ['small business Chapter 11'], ['11 U.S.C. 1181-1195'], 'Debt-limit and small-business engagement checks.'),
  entry('M168', 'Chapter 22 recidivism score', 'v1_1', 'professional_handoff', ['G28'], ['post-emergence'], ['LoPucki Bankruptcy Research Database'], 'Recidivism-risk score from supplied operating and capital-structure inputs.'),
  ...
  entry('M177', 'LP-secondary plus ECI withholding', 'v1_1', 'research_only', ['G26', 'G30'], ['LP secondary'], ['IRC 1446(f)', 'ILPA guidance'], 'PSA, tri-party transfer, and withholding scaffold.'),
  entry('M178', 'Strip-sale pricing', 'v1_1', 'research_only', ['G26', 'G30'], ['strip sale'], ['market practice'], 'Proportionate interest pricing and retained-exposure schedule.'),
  entry('M179', 'NAV facility LTV', 'v1_1', 'professional_handoff', ['G26', 'G30'], ['NAV financing'], ['NAV facility market practice'], 'Loan-to-value, cushion, and collateral pool schedule.'),
  ...
  entry('M181', 'Venture-debt warrant coverage', 'v1_1', 'deterministic', ['G15', 'G29'], ['venture debt'], ['venture-debt market practice'], 'Warrant coverage, exercise price, and lender IRR.'),
  ...
  entry('M187', 'RE-heavy asset-vs-entity election', 'v1_0_core', 'deterministic', ['G30', 'G2'], ['real estate M&A'], ['IRC 1001', 'IRC 1060', 'IRC 197'], 'Asset-deal step-up, entity-deal basis, transfer-tax incidence, debt assumability, and in-place lease treatment.'),
  entry('M188', 'RE/operating-business purchase price bifurcation', 'v1_0_core', 'deterministic', ['G30', 'G2'], ['real estate M&A', 'operating business with real property'], ['Treas. Reg. 1.338-6', 'IRS Form 8594'], 'NOI/cap-rate real-estate value, residual operating-business value, and 1060 Class V/VI/VII reconciliation.'),
  ...
  entry('M190', 'NOI normalization and cap-rate bridge', 'v1_0_core', 'deterministic', ['G30'], ['real estate valuation'], ['Appraisal Institute practice'], 'Effective gross income less operating expenses to NOI, value equals NOI divided by cap rate, and implied cap rate. Market cap rate is pass-through input.'),
  ...
  entry('M193', 'Lease abstraction schema', 'v1_0_core', 'deterministic', ['G30'], ['lease diligence'], ['lease abstraction industry practice'], 'Structured capture of critical lease fields without interpreting legal enforceability.'),
  ...
  entry('M195', 'Property-level escrow and holdback sizing', 'v1_0_core', 'professional_handoff', ['G30'], ['real estate diligence'], ['ALTA endorsements', 'real estate practice norms'], 'Issue-specific escrow sizing for environmental, PCA, title, tenant, and cost-to-cure inputs.'),
  entry('M196', 'Title and survey process checklist', 'v1_0_core', 'professional_handoff', ['G30'], ['real estate closing'], ['ALTA forms', 'state title statutes'], 'Title commitment, Schedule B-II, survey, policy, endorsement, curative-plan, and closing-protection sequencing.'),
  ...
  entry('M198', 'PCA reserve modeling', 'v1_0_core', 'professional_handoff', ['G30'], ['property condition assessment'], ['ASTM E2018', 'lender practice'], 'PCA-driven one-, five-, and twelve-year reserves plus immediate-repair escrow from pass-through report inputs.'),
  entry('M199', 'FIRPTA withholding v1.1', 'v1_0_core', 'deterministic', ['G15', 'G30'], ['real estate M&A', 'foreign seller'], ['IRC 897', 'IRC 1445', 'Forms 8288', 'Forms 8288-A', 'Form 8288-B'], 'FIRPTA 15 percent default, residence exemption/reduced rate, 20-day filing, reduced-withholding certificate, and 1031 timing interaction.'),
  ...
  entry('M214', 'IP chain-of-title verification', 'v1_0_core', 'professional_handoff', ['G10'], ['IP diligence'], ['35 U.S.C. 261', 'Lanham Act 10', '17 U.S.C. 205', 'Clorox v. Chemical Bank'], 'USPTO, trademark, copyright, employee, contractor, and intervening assignment sequence.'),
  entry('M215', 'IP encumbrance and lien search', 'v1_0_core', 'professional_handoff', ['G10'], ['IP diligence', 'secured financing'], ['UCC Article 9', '17 U.S.C. 205', 'In re Peregrine', 'Rhone-Poulenc Agro v. DeKalb'], 'UCC, USPTO security agreement, and copyright office lien-search tracks.'),
  entry('M216', 'License in/out dependency map', 'v1_0_core', 'deterministic', ['G10'], ['IP diligence'], ['IP licensing industry practice'], 'Material license parties, scope, exclusivity, royalty, term, termination, change-of-control, sublicensing, and consent dependencies.'),
  entry('M217', 'Standard IP representation set', 'v1_0_core', 'professional_handoff', ['G1', 'G10'], ['IP purchase agreement'], ['ABA Model SPA IP representations'], 'Industry-scaled IP rep checklist and schedule structure for counsel drafting.'),
  ...
  entry('M219', 'Source-code and IP escrow mechanics', 'v1_0_core', 'deterministic', ['G10'], ['software M&A'], ['Escode', 'Codekeeper', 'Iron Mountain escrow templates'], 'Release triggers, deposit verification tier, and update schedule.'),
  entry('M220', 'Employee IP assignment verification', 'v1_0_core', 'professional_handoff', ['G10'], ['IP diligence'], ['California Labor Code 2870', 'state employee-IP statutes'], 'Contributor-by-contributor assignment and work-for-hire verification with state enforceability flag.'),
  ...
  entry('M222', 'IP-specific 1060 allocation', 'v1_0_core', 'deterministic', ['G2', 'G10'], ['IP-heavy acquisition'], ['IRC 1060', 'Treas. Reg. 1.338-6(b)', 'Treas. Reg. 1.1060-1', 'IRS Form 8594'], 'Class V/VI/VII sub-allocation and residual-method cap ordering for IP-heavy deals.'),
  entry('M223', 'Domain and trademark transfer mechanics', 'v1_0_core', 'deterministic', ['G10'], ['domain transfer', 'trademark transfer'], ['ICANN transfer rules', 'USPTO Form PTO-1594'], 'Registrar auth-code, 60-day lock, trademark assignment recording, state trademark, social-handle, and SSL transfer steps.'),
];
