...
export const DEFINITIVE_DEAL_MECHANICS_CATALOG: DefinitiveModelCatalogEntry[] = [
  ...
  entry('M143', '355 spin and 355(e) test', 'v1_1', 'research_only', ['G15'], ['spin-off', 'split-off', 'Reverse Morris Trust'], ['IRC 355', 'IRC 355(e)'], 'Active-trade/business, device, and 50 percent acquisition-test scaffold.', undefined, 'MODEL.TAX.355.SPIN_RESEARCH.v1'),
  ...
  entry('M161', 'Uptier capacity and sacred rights', 'v1_1_research', 'research_only', ['G29'], ['LME uptier'], ['Serta Simmons', 'Mitel'], 'Required-lender percentage, open-market-purchase language, and contract-risk flags.', undefined, 'MODEL.LME.UPTIER.RESEARCH.v1'),
  entry('M162', 'Drop-down basket capacity', 'v1_1_research', 'research_only', ['G29'], ['LME drop-down'], ['J. Crew', 'Envision', 'Pluralsight'], 'Investment-basket, unrestricted-subsidiary, and blocker capacity.', undefined, 'MODEL.LME.DROPDOWN.RESEARCH.v1'),
  entry('M163', 'Double-dip and pari-plus claim multiplier', 'v1_1_research', 'research_only', ['G29'], ['LME double-dip', 'pari-plus'], ['At Home', 'Trinseo', 'Sabre', 'ABA Business Law Today'], 'Claim multiplier and structural-seniority math.', undefined, 'MODEL.LME.DOUBLEDIP.RESEARCH.v1'),
  ...
  entry('M173', 'Project-finance coverage suite', 'v1_2_research', 'research_only', ['G30'], ['project finance', 'infrastructure'], ['project-finance market practice'], 'DSCR, LLCR, PLCR, and concession-model scaffold.', undefined, 'MODEL.PROJECT_FINANCE.COVERAGE_RESEARCH.v1'),
  entry('M174', 'Crypto token taxonomy', 'v1_2_research', 'research_only', ['G30'], ['crypto M&A'], ['SEC Project Crypto', 'Howey'], 'Howey and Project Crypto classification scaffold.', undefined, 'MODEL.CRYPTO.TOKEN_TAXONOMY.RESEARCH.v1'),
  entry('M175', 'GENIUS Act stablecoin PPS test', 'v1_2_research', 'research_only', ['G30'], ['stablecoin issuer'], ['GENIUS Act'], 'Permitted payment stablecoin framework scaffold.', undefined, 'MODEL.CRYPTO.STABLECOIN_PPS.RESEARCH.v1'),
  entry('M176', 'Digital-asset broker reporting', 'v1_2_research', 'research_only', ['G30'], ['crypto M&A'], ['IRC 6045', 'T.D. 10000', 'Form 1099-DA'], 'Broker-reporting and data-field scaffold.', undefined, 'MODEL.CRYPTO.BROKER_REPORTING.RESEARCH.v1'),
  ...
  entry('M191', 'Real estate transfer and controlling-interest tax', 'v1_1', 'professional_handoff', ['G30', 'G19'], ['real estate M&A'], ['CT 12-638', 'MD Tax-Prop 12-117', 'WA RCW 82.45', 'NY Publication 576'], 'Jurisdictional CITT tax base, rate, aggregation window, and exemption checks. Contested state positions route to specialist review.', undefined, 'MODEL.RE.CITT.TRANSFER_TAX.v1'),
  ...
  entry('M194', 'OpCo/PropCo separation mechanics', 'v1_1', 'professional_handoff', ['G30', 'G2'], ['OpCo/PropCo', 'sale-leaseback'], ['IRC 163(j)', 'IRC 856', 'ASC 842'], 'Bifurcated balance sheet, intercompany lease, interest limitation, and recharacterization-risk threshold schedule.', undefined, 'MODEL.RE.OPCO_PROPCO.SEPARATION.v1'),
  ...
  entry('M197', 'Ground lease vs. fee simple mechanics', 'v1_1', 'professional_handoff', ['G30'], ['ground lease', 'real estate financing'], ['lender practice norms'], 'Remaining term, rent reset, reversion, leasehold mortgageability, cure rights, and financeability flag.', undefined, 'MODEL.RE.GROUND_LEASE.MECHANICS.v1'),
  ...
  entry('M205', 'SALT transaction engine', 'v1_1', 'professional_handoff', ['G2', 'G19'], ['transaction tax', 'state tax'], ['UDITPA', 'state nexus statutes', 'bulk-sale acts'], 'State apportionment, bulk-sale compliance, successor-liability clearances, sales/use tax, and payroll-tax successor elections.', undefined, 'MODEL.TAX.SALT_TRANSACTION.v1'),
  ...
  entry('M209', 'RWI stack architecture', 'v1_1', 'professional_handoff', ['G8'], ['insured M&A'], ['ABA Private Target Deal Points Study 2023', 'Marsh RWI reports', 'Aon RWI reports', 'Lockton RWI reports'], 'Retention, tower size, excess layers, exclusions, and seller-indemnity interaction.', undefined, 'MODEL.LEGAL.RWI_STACK.v1'),
  ...
  entry('M213', 'Earnout architecture and dispute', 'v1_1', 'professional_handoff', ['G9'], ['earnout'], ['SRS Acquiom Earnout data', 'IRC 453', 'IRC 483', 'IRC 1274', 'ABA earnout reports'], 'EBITDA-definition lock, acceleration triggers, post-closing covenants, dispute forum, and tax-characterization selector.', undefined, 'MODEL.LEGAL.EARNOUT_ARCHITECTURE.v1'),
  ...
  entry('M218', 'Carve-out and license-back mechanics', 'v1_1', 'professional_handoff', ['G10'], ['carve-out', 'IP license-back'], ['IP carve-out practice norms'], 'Assigned IP, transition license, perpetual license-back, and TSA-IP overlay.', undefined, 'MODEL.IP.CARVEOUT_LICENSE_BACK.v1'),
...
export const DEFINITIVE_GATE_EXPANSIONS: DefinitiveGateExpansion[] = [
  // Founder-approved 2026-07-17 (Paul, "approve all"). G14 kept as drafted
  // ("Seller Proceeds & Price Adjustment", option A) — the optional QSBS→G15
  // re-route was declined to avoid a routing/conformance change.
  {
    gateId: 'G1',
    name: 'Reps, Warranties & Indemnification',
    purpose: 'Activates the representation-and-warranty architecture and the indemnification-ladder mechanics of the definitive agreement once the deal reaches definitive-agreement drafting.',
    primaryModels: ['M206', 'M207', 'M217'],
    triggerSummary: ['the deal reaches definitive-agreement drafting', 'Machine predicate: `definitive_agreement_stage == true`'],
    lineNotes: 'DEFINITIVE sizes the indemnity, survival, and standard-representation architecture; drafting, negotiating, and the enforceability of the reps and remedies are counsel\'s.',
  },
  {
    gateId: 'G2',
    name: 'Transaction Form & Purchase-Price Allocation',
    purpose: 'Activates the asset/stock/merger form fork and the purchase-price-allocation mechanics that follow from the chosen form.',
    primaryModels: ['M187', 'M188', 'M194', 'M200', 'M201', 'M202', 'M203', 'M204', 'M205', 'M222', 'M234'],
    triggerSummary: ['an asset, stock, or merger form is chosen for a priced deal', 'Machine predicate: `deal_form in {asset, stock, merger} AND purchase_price_cents > 0`'],
    lineNotes: 'DEFINITIVE computes the form-driven allocation and structure math; the binding tax and legal positions belong to the tax advisor and counsel.',
  },
  {
    gateId: 'G6',
    name: 'Closing Conditions',
    purpose: 'Activates condition-precedent tracking for the period between signing and closing.',
    primaryModels: ['M211'],
    triggerSummary: ['the deal is signed but not yet closed', 'Machine predicate: `signed == true AND closed == false`'],
    lineNotes: 'DEFINITIVE tracks the condition nodes and what blocks closing; whether a condition is satisfied or waivable is a legal determination for counsel.',
  },
  {
    gateId: 'G7',
    name: 'Execution & Closing Certainty',
  ...
  {
    gateId: 'G8',
    name: 'Post-Closing Recourse',
    purpose: 'Activates escrow, holdback, survival, and insurance-backed recourse sizing after closing.',
    primaryModels: ['M206', 'M207', 'M208', 'M209'],
    triggerSummary: ['an indemnity/escrow recourse structure is required', 'Machine predicate: `indemnity_structure_required == true`'],
    lineNotes: 'DEFINITIVE sizes escrow, holdback, survival, and RWI recourse; the binding terms and policy wording belong to counsel and the broker/underwriter.',
  },
  {
    gateId: 'G9',
    name: 'Contingent Consideration',
    purpose: 'Activates earnout design, measurement, and dispute mechanics when part of the price is contingent.',
    primaryModels: ['M213'],
    triggerSummary: ['part of the price is contingent (an earnout)', 'Machine predicate: `contingent_consideration == true`'],
    lineNotes: 'DEFINITIVE structures the earnout architecture and dispute path; the enforceable covenant set and the §453/§483/§1274 tax characterization route to counsel and the tax advisor.',
  },
  {
    gateId: 'G10',
    name: 'Intellectual Property Mechanics',
    purpose: 'Activates IP diligence, chain-of-title, transfer, and allocation mechanics when IP is material to value.',
    primaryModels: ['M214', 'M215', 'M216', 'M217', 'M218', 'M219', 'M220', 'M221', 'M222', 'M223'],
    triggerSummary: ['IP is material to value', 'Machine predicate: `ip_material_to_value == true`'],
    lineNotes: 'DEFINITIVE runs IP chain-of-title, encumbrance, license-dependency, and transfer mechanics; enforceability and freedom-to-operate opinions belong to IP counsel.',
  },
  {
    gateId: 'G14',
    name: 'Seller Proceeds & Price Adjustment',
  ...
  {
    gateId: 'G23',
    name: 'Cross-Border Deal Terms',
    purpose: 'Activates non-US deal-term and merger-control overlays when a non-US jurisdiction is in play.',
    primaryModels: ['M106', 'M107', 'M110'],
    triggerSummary: ['a non-US jurisdiction is in play', 'Machine predicate: `non_us_jurisdiction == true`'],
    lineNotes: 'DEFINITIVE overlays non-US deal-term and merger-control considerations; local-law determinations belong to local counsel.',
  },
  {
    gateId: 'G24',
    name: 'Regulatory & Compliance Diligence Overlays',
    purpose: 'Activates the regulatory-diligence overlay family (privacy, cyber, sanctions, ESG, sector regulation) for regulated data or operations.',
    primaryModels: ['M129', 'M130', 'M131', 'M132', 'M133', 'M134'],
    triggerSummary: ['regulated data or operations are present', 'Machine predicate: `regulated_data_or_operations == true`'],
    lineNotes: 'DEFINITIVE organizes the regulatory-diligence overlays; compliance and enforcement determinations belong to regulatory counsel.',
  },
  {
    gateId: 'G26',
  ...
  {
    gateId: 'G27',
    name: 'Sponsor, Search & Employee-Ownership Economics',
    purpose: 'Activates acquirer-archetype economics — independent-sponsor promotes, search-fund step-ups, and ESOP structures.',
    primaryModels: ['M102', 'M116', 'M117', 'M118'],
    triggerSummary: ['the acquirer is an independent sponsor, search fund, or ESOP', 'Machine predicate: `buyer_archetype in {independent_sponsor, search_fund, esop}`'],
    lineNotes: 'DEFINITIVE computes acquirer-archetype economics; ESOP fiduciary and valuation determinations belong to the trustee and the appraiser.',
  },
  {
    gateId: 'G28',
