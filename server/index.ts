...
<body style="margin:0;background:#FFFFFF;color:#16181A;font-family:-apple-system,'Segoe UI',sans-serif">
  ...
  try {
    ...
    const html = shell
      ...
      .replace(
        ...
        `<meta property="og:image" content="${esc(origin + (report.ogImage || '/site-card-v3.png'))}" />`,
      )
