    ...
    <div className={dark ? 'bg-transparent text-[#f9f9fc]' : 'bg-transparent text-[#1a1c1e]'}>
      <div className="pt-12 pb-24 px-6 md:px-12 max-w-6xl mx-auto">
        ...
        <ScrollReveal>
          <section className="mb-24">
            <div className="max-w-4xl">
              <span className="inline-block px-3 py-1 bg-[#A03050]/10 text-[#A03050] text-[10px] font-black uppercase tracking-[0.2em] mb-8 rounded-sm">How It Works</span>
              <h1 className="font-headline text-5xl md:text-7xl font-black tracking-tighter leading-[0.9] mb-8">Every step of your deal.<br/><span className="text-[#A03050]">Guided.</span></h1>
              ...
              {[
                ...
                <StaggerItem key={j.title}>
                  <div className={`${card} rounded-2xl p-8 hover:shadow-lg transition-all h-full`}>
                    <span className="material-symbols-outlined text-[#A03050] text-3xl mb-4">{j.icon}</span>
                    <h3 className="font-headline font-black text-xl mb-2">{j.title}</h3>
                    <p className={`text-sm leading-relaxed ${muted}`}>{j.desc}</p>
                    <p className="text-xs text-[#A03050] font-bold mt-4">{j.timeline}</p>
                  </div>
                </StaggerItem>
              ))}
            </StaggerContainer>
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                <span className="text-[#A03050] font-bold uppercase tracking-widest text-xs block mb-3">Enforced Methodology</span>
                ...
                <div className={`mt-8 ${darkPanel} rounded-2xl p-6 text-white`}>
                  <h4 className="font-bold text-sm mb-3 flex items-center gap-2"><span className="material-symbols-outlined text-[#A03050] text-lg">lock</span>What this means in practice</h4>
              ...
              <div className="space-y-4">
                ...
                <div className={`${card} rounded-2xl p-6`}>
                  <div className="flex items-center gap-3 mb-4"><span className="material-symbols-outlined text-[#A03050]">storefront</span><h4 className="font-headline font-bold">Sell — 6 Gates</h4></div>
                  <div className="flex gap-2">
                    {['S0','S1','S2','S3','S4','S5'].map((g, i) => (
                      <div key={g} className="flex-1 text-center">
                        <div className={`${i < 2 ? (dark ? 'bg-[#006630]/20' : 'bg-[#006630]/10') : 'bg-[#A03050]/10'} rounded-lg py-2 px-1 mb-1`}>
                          <span className={`text-[10px] font-bold ${i < 2 ? 'text-[#006630]' : 'text-[#A03050]'}`}>{g}</span>
                        </div>
                ...
                {/* Buy gates */}
                <div className={`${card} rounded-2xl p-6`}>
                  <div className="flex items-center gap-3 mb-4"><span className="material-symbols-outlined text-[#A03050]">shopping_bag</span><h4 className="font-headline font-bold">Buy — 6 Gates</h4></div>
                  <div className="flex gap-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className={`${card} rounded-2xl p-6`}>
                    <div className="flex items-center gap-3 mb-3"><span className="material-symbols-outlined text-[#A03050]">trending_up</span><h4 className="font-headline font-bold text-sm">Raise — 6 Gates</h4></div>
                    <div className="flex gap-1">
                      {['R0','R1','R2','R3','R4','R5'].map((g, i) => (
                        <div key={g} className="flex-1 text-center">
                          <div className={`${i < 2 ? (dark ? 'bg-[#006630]/20' : 'bg-[#006630]/10') : 'bg-[#A03050]/10'} rounded-lg py-1.5 mb-1`}>
                            <span className={`text-[9px] font-bold ${i < 2 ? 'text-[#006630]' : 'text-[#A03050]'}`}>{g}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className={`${card} rounded-2xl p-6`}>
                    <div className="flex items-center gap-3 mb-3"><span className="material-symbols-outlined text-[#A03050]">merge</span><h4 className="font-headline font-bold text-sm">Integrate — 4 Gates</h4></div>
                    <div className="flex gap-1">
                      {['I0','I1','I2','I3'].map((g, i) => (
                        <div key={g} className="flex-1 text-center">
                          <div className={`${i < 1 ? (dark ? 'bg-[#006630]/20' : 'bg-[#006630]/10') : 'bg-[#A03050]/10'} rounded-lg py-1.5 mb-1`}>
                            <span className={`text-[9px] font-bold ${i < 1 ? 'text-[#006630]' : 'text-[#A03050]'}`}>{g}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                <div className="flex items-center gap-3 px-2">
                  ...
                  <div className="w-3 h-3 rounded-sm bg-[#A03050]/10 ml-3" />
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className="mb-12">
              <span className="text-[#A03050] font-bold uppercase tracking-widest text-xs block mb-3">What It Feels Like</span>
            ...
            <div className={`${darkPanel} rounded-3xl p-8 md:p-12`}>
              <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="flex gap-3 items-start">
                  <div className="w-8 h-8 rounded-full bg-[#A03050] flex items-center justify-center text-white text-xs font-bold shrink-0">Y</div>
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className="mb-12">
              <span className="text-[#A03050] font-bold uppercase tracking-widest text-xs block mb-3">AI Orchestration</span>
              ...
              {engines.map((e) => (
                <StaggerItem key={e.title}>
                  <div className={`${card} rounded-2xl p-6 h-full`}>
                    <div className="flex items-center gap-3 mb-4"><span className="material-symbols-outlined text-[#A03050]">{e.icon}</span><h4 className="font-bold text-sm">{e.title}</h4></div>
            ...
            <div className={`mt-8 ${darkPanel} rounded-2xl p-8 grid grid-cols-1 md:grid-cols-2 gap-8 text-white`}>
              <div>
                <div className="flex items-center gap-3 mb-4"><span className="material-symbols-outlined text-[#A03050]">edit_note</span><h4 className="font-bold">Author Mode</h4><span className="text-[10px] bg-white/10 px-2 py-1 rounded">Creative</span></div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-4"><span className="material-symbols-outlined text-[#A03050]">fact_check</span><h4 className="font-bold">Auditor Mode</h4><span className="text-[10px] bg-white/10 px-2 py-1 rounded">Forensic</span></div>
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className="mb-12">
              <span className="text-[#A03050] font-bold uppercase tracking-widest text-xs block mb-3">Analytical Framework</span>
              <h2 className="font-headline text-4xl md:text-5xl font-black tracking-tight mb-4">Every deal analyzed across seven dimensions. <span className="text-[#A03050]">Simultaneously.</span></h2>
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {dimensions.map((d) => (
                <StaggerItem key={d.title}>
                  <div className={`p-8 ${card} rounded-2xl hover:shadow-xl hover:shadow-[#A03050]/5 transition-all h-full`}>
                    <span className="material-symbols-outlined text-[#A03050] text-4xl mb-4">{d.icon}</span>
              ...
              <StaggerItem>
                <div className="md:col-span-2 p-8 bg-[#A03050] text-white rounded-2xl">
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                <span className="text-[#A03050] font-bold uppercase tracking-widest text-xs block mb-3">Market Intelligence</span>
              ...
              <div className="space-y-4">
                <div className={`${darkPanel} rounded-2xl p-6 text-white`}>
                  <h4 className="font-bold text-sm mb-4 flex items-center gap-2"><span className="material-symbols-outlined text-[#A03050] text-lg">local_fire_department</span>Market Heat Index</h4>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={l.n} className="flex items-center gap-3">
                        <div className={`w-6 h-6 rounded bg-[#A03050]${l.opacity} flex items-center justify-center text-white text-[9px] font-bold`}>{l.n}</div>
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className="mb-12">
              <span className="text-[#A03050] font-bold uppercase tracking-widest text-xs block mb-3">Industry Intelligence</span>
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {industries.map((ind) => (
                <StaggerItem key={ind.name}>
                  <div className={`${card} rounded-2xl p-6 h-full`}>
                    <div className="flex items-center justify-between mb-3"><h4 className="font-bold text-sm">{ind.name}</h4><span className="text-[9px] bg-[#A03050]/10 text-[#A03050] px-2 py-1 rounded font-bold">{ind.badge}</span></div>
            ...
            <div className={`${subtleBg} rounded-2xl p-6 flex items-start gap-4`}>
              <span className="material-symbols-outlined text-[#A03050] text-2xl shrink-0 mt-1">inventory_2</span>
              <div>
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className="border-l-8 border-[#A03050] pl-8 mb-12">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              <div className={`flex-1 bg-white p-10 rounded-3xl border ${borderColor} shadow-sm`}>
                <div className="flex justify-between items-start mb-8">
                  ...
                  <div className="bg-[#A03050]/10 px-4 py-2 rounded-xl text-[#A03050] font-bold text-sm">$380K SDE</div>
                </div>
                <div className="space-y-4 mb-8"><div className="flex items-center gap-3"><div className="w-10 h-1 bg-[#A03050] rounded-full" /><span className="text-sm font-bold text-[#1a1c1e]">Labor Elasticity: HIGH</span></div><p className="text-sm text-[#5d5e61] leading-relaxed">Population growth driving demand, but labor costs rising faster than contract prices. Margin compression risk must be priced in.</p></div>
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className="mb-12">
              <span className="text-[#A03050] font-bold uppercase tracking-widest text-xs block mb-3">Adaptive Intelligence</span>
              ...
              {leagues.map((l) => (
                <StaggerItem key={l.title}>
                  <div className={`${card} rounded-2xl overflow-hidden h-full`}>
                    <div className={`bg-[#A03050]/5 p-6 border-b ${borderColor}`}>
                      <div className="flex items-center gap-3 mb-2"><span className="material-symbols-outlined text-[#A03050]">{l.icon}</span><h3 className="font-headline font-black text-lg">{l.title}</h3></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
              <div className={`${dark ? 'bg-[#A03050]/10 border border-[#A03050]/20' : 'bg-[#A03050]/5 border border-[#A03050]/15'} rounded-2xl p-6 flex items-start gap-4`}>
              ...
              <div className={`${subtleBg} border ${borderColor} rounded-2xl p-6 flex items-start gap-4`}>
                <span className="material-symbols-outlined text-[#A03050] text-2xl shrink-0 mt-1">verified</span>
          ...
          <section className="mb-32">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
              <div className="lg:col-span-5">
                <span className="text-[#A03050] font-bold uppercase tracking-widest text-xs block mb-3">The Math Engine</span>
                ...
                <div className={`mt-10 ${darkPanel} rounded-2xl p-6 text-white`}>
                  <h4 className="font-bold text-sm mb-4 flex items-center gap-2"><span className="material-symbols-outlined text-[#A03050] text-lg">sync</span>The Verification Loop</h4>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3"><div className="w-7 h-7 rounded-lg bg-[#A03050] flex items-center justify-center text-white text-xs font-bold shrink-0">1</div><div><p className="text-sm font-semibold">AI Identifies</p><p className="text-xs text-[#dadadc]/70">Scans for add-backs — vehicles, rent, travel, one-time legal fees, family payroll — using IRS industry benchmarks.</p></div></div>
              ...
              <div className="lg:col-span-7 space-y-4">
                <div className={`${card} rounded-2xl p-6`}>
                  <div className="flex items-center gap-3 mb-4"><span className="material-symbols-outlined text-[#A03050]">calculate</span><h4 className="font-bold">SDE (Seller Discretionary Earnings)</h4></div>
                ...
                <div className={`${card} rounded-2xl p-6`}>
                  <div className="flex items-center gap-3 mb-4"><span className="material-symbols-outlined text-[#A03050]">monitoring</span><h4 className="font-bold">Adjusted EBITDA</h4></div>
                ...
                <div className={`${card} rounded-2xl p-6`}>
                  <div className="flex items-center gap-3 mb-4"><span className="material-symbols-outlined text-[#A03050]">account_balance_wallet</span><h4 className="font-bold">DSCR (Debt Service Coverage)</h4></div>
                ...
                <div className={`${darkPanel} rounded-2xl p-6 text-white`}>
                  <div className="flex items-center gap-3 mb-4"><span className="material-symbols-outlined text-[#A03050]">speed</span><h4 className="font-bold">Valuation Defense</h4></div>
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-headline text-4xl font-black text-center mb-12">What does this do that <span className="text-[#A03050]">ChatGPT can't?</span></h2>
              <div className={`${card} rounded-2xl overflow-hidden`}>
                <table className="w-full text-left">
                  <thead><tr className={subtleBg}><th className={`px-6 py-4 text-xs font-bold uppercase tracking-widest ${muted}`}>Capability</th><th className={`px-6 py-4 text-xs font-bold uppercase tracking-widest ${muted}`}>Standard AI</th><th className="px-6 py-4 text-xs font-bold uppercase tracking-widest text-[#A03050]">smbX.ai</th></tr></thead>
                  <tbody className={`divide-y ${borderColor} text-sm`}>
                    {comparisonRows.map((r) => (
                      <tr key={r.feature}>
                        ...
                        <td className="px-6 py-4"><span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-[#A03050] text-sm">check_circle</span>{r.smbx}</span></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                <div className="lg:col-span-5">
                  <span className="text-[#A03050] font-bold uppercase tracking-widest text-xs block mb-3">Coverage Comparison</span>
                  ...
                  <p className={`font-bold text-xl border-l-4 border-[#A03050] pl-6 italic ${emphasis}`}>Yulia is the analyst, the associate, and the VP. You're the Managing Director.</p>
                </div>
                  ...
                  <div className={`${card} rounded-2xl overflow-hidden`}>
                    <table className="w-full text-left">
                      <thead><tr className={subtleBg}>
                        ...
                        <th className="px-5 py-4 text-xs font-bold uppercase tracking-widest text-[#A03050]">smbX.ai</th>
                      </tr></thead>
                      <tbody className={`divide-y ${borderColor} text-sm`}>
                        {ibRows.map((r) => (
                          <tr key={r.ib}>
                            <td className={`px-5 py-3.5 ${muted}`}>{r.ib}</td>
                            <td className="px-5 py-3.5"><span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-[#A03050] text-sm">check_circle</span>{r.smbx}</span></td>
                          </tr>
                        ))}
                        ...
                        <tr className={`${darkPanel} text-white`}><td className="px-5 py-4 font-bold">Total (12-month engagement)</td><td className="px-5 py-4 font-bold text-[#A03050]">$1,788/year vs. $150K–$500K+</td></tr>
                      </tbody>
                    </table>
                  </div>
                  <div className={`mt-4 ${dark ? 'bg-[#A03050]/10 border border-[#A03050]/20' : 'bg-[#A03050]/5 border border-[#A03050]/15'} rounded-2xl p-5 flex items-start gap-3`}>
                    <span className="material-symbols-outlined text-[#A03050] text-lg shrink-0 mt-0.5">info</span>
              ...
              {journeys.map((j) => (
                <StaggerItem key={j.title}>
                  <a href={j.href} className={`${card} p-8 rounded-2xl hover:shadow-lg transition-all group flex gap-6 items-start`}>
                    <span className="material-symbols-outlined text-[#A03050] text-3xl shrink-0 mt-1 group-hover:scale-110 transition-transform">{j.icon}</span>
                    <div>
                      <h3 className="font-headline text-xl font-black mb-2">{j.title}</h3>
                      <p className={`text-sm leading-relaxed ${muted}`}>{j.desc}</p>
                      <span className="text-[#A03050] text-xs font-bold mt-3 inline-flex items-center gap-1 group-hover:gap-2 transition-all">Learn more <span className="material-symbols-outlined text-sm">arrow_forward</span></span>
                    </div>
                  </a>
                </StaggerItem>
              ))}
        ...
        <ScrollReveal>
          <section className="mb-32">
            <div className={`${darkPanel} rounded-3xl p-10 md:p-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center`}>
              <div>
                <span className="material-symbols-outlined text-[#A03050] text-4xl mb-6">shield</span>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={p.icon} className="bg-white/5 p-6 rounded-xl border border-white/10 text-center">
                    <span className="material-symbols-outlined text-[#A03050] text-2xl mb-2">{p.icon}</span>
        ...
        <ScrollReveal>
          <section className="mb-12 text-center max-w-4xl mx-auto">
            <div className={`${subtleBg} py-20 px-10 rounded-3xl`}>
              <h2 className="font-headline text-5xl md:text-6xl font-black tracking-tighter mb-6 leading-none">See for <span className="text-[#A03050] italic">yourself.</span></h2>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <button onClick={handleCTA} className="px-12 py-6 bg-gradient-to-r from-[#A03050] to-[#C45878] text-white rounded-full font-black text-xl hover:scale-105 transition-all shadow-xl border-none cursor-pointer">Talk to Yulia</button>
