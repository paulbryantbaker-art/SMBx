...
export default function HowItWorksBelow({ onChipClick }: HowItWorksBelowProps) {
  return (
    <div>
      ...
      {/* ═══ Block 3 — Canvas: Seven Layers of Intelligence ═══ */}
      <section className="px-6" style={{ paddingTop: '140px' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10">
            {[
              ...
              <div key={item.num} className="flex gap-4">
                <span style={{ fontSize: '28px', fontWeight: 700, color: '#D4714E', lineHeight: 1, minWidth: 28, textAlign: 'center' }} className="shrink-0 mt-0.5">{item.num}</span>
                <div>
