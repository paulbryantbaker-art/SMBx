          ...
          <div className={`grid transition-all duration-700 ease-in-out w-full ${viewState === 'landing' ? 'grid-rows-[1fr] opacity-100 mt-8' : 'grid-rows-[0fr] opacity-0 mt-0'}`}>
            <div className="overflow-hidden flex flex-col items-center">
              <div className="flex flex-wrap justify-center gap-3 max-w-3xl mb-6">
                <Suggestion text="Package a new listing" onClick={() => handleChipSend("I'm a broker. I need to package a new listing for a commercial cleaning company.")} />
                <Suggestion text="Pre-screen a buyer for SBA" onClick={() => handleChipSend("I need to pre-screen a buyer's financials for an SBA 7(a) loan.")} />
                <Suggestion text="Generate a CIM" onClick={() => handleChipSend("I need to generate a CIM from these raw financials.")} />
              </div>
              ...
              <div className="max-w-6xl mx-auto">
                <div className="mb-16 md:flex justify-between items-end gap-8">
                  <div className="max-w-2xl">
                    ...
                    <p className="text-[#6E6A63] text-lg leading-relaxed">Great advisors are limited by the same thing: hours in the day. The smbX.ai Engine handles the data assembly, financial modeling, and formatting, so you can focus on negotiations and strategic counsel.</p>
                  </div>
                  <div className="mt-8 md:mt-0 flex items-center gap-4 bg-white px-6 py-5 rounded-2xl border border-[#EAE6DF] shadow-sm">
                    ...
                    <div><div className="text-xs text-[#A9A49C] uppercase tracking-wider font-bold">Proprietary Tech</div><div className="font-bold text-lg text-[#1A1A18]">smb<span className="text-[#D4714E]">X</span>.ai Engine</div></div>
                  </div>
                </div>
                <div className="grid md:grid-cols-3 gap-4 md:gap-6">
                  <div className="md:col-span-2 bg-white rounded-3xl p-8 border border-[#EAE6DF] shadow-sm"><h3 className="text-2xl font-bold mb-4">Package a new listing in minutes</h3><p className="text-[#6E6A63] mb-8 max-w-lg leading-relaxed">A new seller engagement used to mean days of manual research. Tell Yulia about the business and get instant market intelligence, preliminary valuations, and add-back identification.</p><div className="flex flex-wrap gap-2"><Badge text="Instant Valuations" /><Badge text="Market Comps" /><Badge text="SBA Pre-screen" /></div></div>
                  <div className="bg-white rounded-3xl p-8 border border-[#EAE6DF] shadow-sm flex flex-col"><div className="w-12 h-12 bg-[#F8F6F1] rounded-xl flex items-center justify-center text-[#D4714E] font-black text-xl mb-6">01</div><h3 className="text-xl font-bold mb-3">Qualify buyers instantly</h3><p className="text-[#6E6A63] text-sm leading-relaxed mt-auto">Pre-screen buyer financials against SBA requirements. Model DSCR and assess financing feasibility before scheduling a call.</p></div>
                  <div className="bg-white rounded-3xl p-8 border border-[#EAE6DF] shadow-sm flex flex-col md:col-span-3 lg:col-span-1"><div className="w-12 h-12 bg-[#F8F6F1] rounded-xl flex items-center justify-center text-[#D4714E] font-black text-xl mb-6">02</div><h3 className="text-xl font-bold mb-3">Make smaller deals profitable</h3><p className="text-[#6E6A63] text-sm leading-relaxed mt-auto">The infrastructure that makes a $10M engagement great makes a $1M engagement viable. Serve deals you&apos;d normally turn away.</p></div>
                  <div className="bg-[#D4714E] rounded-3xl p-8 flex items-center justify-between md:col-span-2 text-white shadow-md"><div className="max-w-lg"><h3 className="text-3xl font-bold mb-3">Present intelligence under your brand.</h3><p className="text-orange-100 font-medium leading-relaxed">Every deliverable Yulia generates&mdash;valuations, Market Intelligence Reports, CIMs&mdash;can be white-labeled with your firm&apos;s identity.</p></div></div>
                </div>
              </div>
            </section>

            <section className="px-6 py-24 max-w-5xl mx-auto w-full">
              <div className="text-center mb-16"><h2 className="text-4xl font-bold mb-4">See how a broker preps a listing</h2><p className="text-[#6E6A63] text-lg">The first five minutes of a new engagement.</p></div>
              <div className="bg-[#F8F6F1] rounded-[40px] p-6 md:p-10 border border-[#EAE6DF] shadow-xl max-w-4xl mx-auto">
                <div className="flex flex-col gap-6">
                  <div className="self-end bg-[#D4714E] text-white p-6 rounded-[24px] rounded-br-[8px] max-w-[85%] md:max-w-[75%] shadow-md text-[16px] leading-relaxed">I just signed an engagement for a commercial cleaning company in Atlanta. They&apos;re doing about $1.8M revenue, $320K SDE. Need to prep for the pricing convo.</div>
                  <div className="self-start flex gap-4 max-w-[95%] md:max-w-[85%]">
                    ...
                    <div className="bg-white border border-[#EAE6DF] p-6 md:p-8 rounded-[24px] rounded-tl-[8px] shadow-md text-[#1A1A18] text-[16px] leading-relaxed">
                      ...
                      <div className="bg-[#FDFCFB] border border-[#EAE6DF] rounded-2xl p-6 mb-6 shadow-sm"><div className="text-sm text-[#6E6A63] uppercase tracking-wider font-bold mb-1">Preliminary Range</div><div className="text-3xl font-black text-[#1A1A18]">$896K &ndash; $1.12M</div></div>
                      <div className="space-y-4 text-[15px] mb-6">
                        <div className="flex items-start gap-3 bg-green-50/50 p-4 rounded-xl border border-green-100"><div className="mt-1 font-black text-green-600">&check;</div><div><strong>SBA Bankability:</strong> Looks strong. At $1M enterprise value, DSCR is approx 1.7x on a standard 7(a), well above the 1.25x minimum. Broader buyer pool.</div></div>
                      </div>
            ...
            <section className="px-6 py-24 bg-white border-t border-[#EAE6DF]">
              <div className="max-w-4xl mx-auto">
                <div className="bg-[#FDFCFB] border border-[#EAE6DF] rounded-[40px] p-8 md:p-12 shadow-xl shadow-[#1A1A18]/5">
                  <div className="text-center mb-12"><h2 className="text-3xl md:text-4xl font-bold mb-6">The infrastructure of a mega-firm. Right in your practice.</h2><p className="text-lg text-[#6E6A63] leading-relaxed">You don&apos;t need a floor full of junior analysts to deliver institutional-grade service. smbX.ai gives you the leverage to operate at the highest level of the profession.</p></div>
