        ...
        <div className="overflow-hidden">
          <div className="border-t border-[#EAE6DF]">
              ...
              <div className="max-w-6xl mx-auto">
                <div className="mb-16 md:flex justify-between items-end gap-8">
                  <div className="max-w-2xl">
                    ...
                    <p className="text-[#6E6A63] text-lg leading-relaxed">Selling a business is the most consequential financial decision most owners make. smbX.ai doesn&apos;t just estimate your value&mdash;it builds the defensible, data-backed case to justify your asking price.</p>
                  </div>
                ...
                <div className="grid md:grid-cols-3 gap-4 md:gap-6">
                  <div className="md:col-span-2 bg-white rounded-3xl p-8 border border-[#EAE6DF] shadow-sm"><h3 className="text-2xl font-bold mb-4">Find the hidden money in your financials</h3><p className="text-[#6E6A63] mb-8 max-w-lg leading-relaxed">Your tax return isn&apos;t your valuation. Yulia identifies owner salaries, personal vehicles, one-time expenses, and family benefits to calculate your true Seller&apos;s Discretionary Earnings (SDE).</p><div className="flex flex-wrap gap-2"><Badge text="Identify Add-backs" /><Badge text="Normalize EBITDA" /><Badge text="Justify Multiples" /></div></div>
                  <div className="bg-white rounded-3xl p-8 border border-[#EAE6DF] shadow-sm flex flex-col"><div className="w-12 h-12 bg-[#F8F6F1] rounded-xl flex items-center justify-center text-[#D4714E] font-black text-xl mb-6">01</div><h3 className="text-xl font-bold mb-3">SBA Pre-qualification</h3><p className="text-[#6E6A63] text-sm leading-relaxed mt-auto">Can a buyer actually finance your asking price? Yulia models live SBA rates and DSCR so you know before you list.</p></div>
                  <div className="bg-white rounded-3xl p-8 border border-[#EAE6DF] shadow-sm flex flex-col md:col-span-3 lg:col-span-1"><div className="w-12 h-12 bg-[#F8F6F1] rounded-xl flex items-center justify-center text-[#D4714E] font-black text-xl mb-6">02</div><h3 className="text-xl font-bold mb-3">Market Intelligence</h3><p className="text-[#6E6A63] text-sm leading-relaxed mt-auto">Know exactly how many competitors operate in your ZIP code and whether Private Equity is rolling up your industry.</p></div>
                  <div className="bg-[#D4714E] rounded-3xl p-8 flex items-center justify-between md:col-span-2 text-white shadow-md"><div className="max-w-lg"><h3 className="text-3xl font-bold mb-3">Institutional CIMs in minutes, not weeks.</h3><p className="text-orange-100 font-medium leading-relaxed">Turn your raw financials into a 25-page Confidential Information Memorandum built to withstand buyer scrutiny.</p></div></div>
                </div>
              </div>
            </section>

            <section className="px-6 py-24 max-w-5xl mx-auto w-full">
              <div className="text-center mb-16"><h2 className="text-4xl font-bold mb-4">Finding the hidden money</h2><p className="text-[#6E6A63] text-lg">See how Yulia extracts your actual Seller&apos;s Discretionary Earnings (SDE).</p></div>
              <div className="bg-[#F8F6F1] rounded-[40px] p-6 md:p-10 border border-[#EAE6DF] shadow-xl max-w-4xl mx-auto">
                <div className="flex flex-col gap-6">
                  <div className="self-end bg-[#D4714E] text-white p-6 rounded-[24px] rounded-br-[8px] max-w-[85%] md:max-w-[75%] shadow-md text-[16px] leading-relaxed">I&apos;m thinking of selling my plumbing business. We did $1.2M last year. Tax return shows $50K net income, but I take a $120K salary, and the business pays for my truck and family health insurance.</div>
                  <div className="self-start flex gap-4 max-w-[95%] md:max-w-[85%]">
                    ...
                    <div className="bg-white border border-[#EAE6DF] p-6 md:p-8 rounded-[24px] rounded-tl-[8px] shadow-md text-[#1A1A18] text-[16px] leading-relaxed">
                      ...
                      <div className="bg-[#FDFCFB] border border-[#EAE6DF] rounded-2xl p-6 mb-6 shadow-sm font-mono text-sm">
                        ...
                        <div className="flex justify-between pt-1"><span className="font-bold font-sans">True SDE (Cash Flow):</span><span className="font-bold text-[#D4714E] text-lg">$200,000</span></div>
                      </div>
                      <div className="space-y-4 text-[15px] mb-6">
                        <div className="flex items-start gap-3 bg-green-50/50 p-4 rounded-xl border border-green-100"><div className="mt-1 font-black text-green-600">&check;</div><div><strong>Valuation Impact:</strong> By identifying just those basic add-backs, your valuation basis jumped from $50K to $200K. At a standard 2.5x&ndash;3.2x multiple, your enterprise value is roughly <strong>$500K to $640K</strong>.</div></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="px-6 py-24 bg-white border-y border-[#EAE6DF]">
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16"><div className="text-sm font-bold text-[#A9A49C] uppercase tracking-widest mb-4">The Deliverables</div><h2 className="text-3xl md:text-4xl font-bold mb-4">What you actually walk away with.</h2><p className="text-[#6E6A63] text-lg max-w-2xl mx-auto">You don&apos;t just get chat advice. Yulia instantly generates the exact institutional-grade collateral you need to market and close your business.</p></div>
            ...
            <section className="px-6 py-24 bg-[#F8F6F1] border-t border-[#EAE6DF]">
              <div className="max-w-4xl mx-auto">
                <div className="bg-white border border-[#EAE6DF] rounded-[40px] p-8 md:p-12 shadow-xl shadow-[#1A1A18]/5">
                  <div className="text-center mb-12"><h2 className="text-3xl md:text-4xl font-bold mb-6">The power to close on your terms.</h2><p className="text-lg text-[#6E6A63] leading-relaxed">Whether you are a first-time seller or exiting your third company, smbX.ai gives you the superpower to execute flawlessly. It&apos;s absolute clarity when it matters most.</p></div>
