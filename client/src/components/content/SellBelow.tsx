    ...
    <div className={dark ? 'bg-transparent text-[#f9f9fc]' : 'bg-transparent text-[#1a1c1e]'}>
      <div className="pt-12 pb-24 px-6 md:px-12 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-7">
            <ScrollReveal>
              <div className="flex items-center gap-2 mb-8">
                <span className="inline-block px-3 py-1 bg-[#A85860]/10 text-[#A85860] text-[10px] font-black uppercase tracking-[0.2em] rounded-sm">Sell</span>
            ...
            <ScrollReveal y={40} delay={0.1}>
              <h1 className="font-headline font-black text-5xl md:text-6xl tracking-tighter leading-[0.92] mb-8">
                75% of owners who sell profoundly <span className="text-[#A85860]">regret it</span> within a year.
              </h1>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <div className={`space-y-6 text-xl editorial max-w-xl ${dark ? 'text-[#dadadc]/80' : 'text-[#5d5e61]'}`}>
                ...
                <p className={`font-bold border-l-4 border-[#A85860] pl-6 text-2xl italic ${dark ? 'text-[#f9f9fc]' : 'text-[#1a1c1e]'}`}>Yulia makes sure that doesn't happen to you.</p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <ScrollReveal className="lg:col-span-5">
              <span className="text-[#A85860] font-bold uppercase tracking-widest text-xs block mb-3">Your Exit Process</span>
              <h2 className="text-4xl font-headline font-black tracking-tight mb-8">Eight stages. Yulia manages every one.</h2>
              <p className={`font-bold text-xl border-l-4 border-[#A85860] pl-6 italic mb-8 ${dark ? 'text-[#f9f9fc]' : 'text-[#1a1c1e]'}`}>You don't need to know the process. You just need to show up for the decisions.</p>
              ...
              {[
                ...
                <StaggerItem key={step.num}>
                  <div className={`rounded-2xl p-6 flex items-start gap-4 ${dark ? 'bg-[#2f3133] border border-zinc-800' : 'bg-white border border-[#eeeef0]'}`}>
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold shrink-0 ${step.free ? 'bg-[#006630]/10 text-[#006630]' : 'bg-[#A85860]/10 text-[#A85860]'}`}>{step.num}</div>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <ScrollReveal className="lg:col-span-5">
              <span className="text-[#A85860] font-bold uppercase tracking-widest text-xs block mb-3">Negotiation Intelligence</span>
            ...
            <ScrollReveal delay={0.15} className="lg:col-span-7">
              <div className={`rounded-3xl p-8 text-white ${dark ? 'bg-[#0f1012]' : 'bg-[#1a1c1e]'}`}>
                ...
                <div className="space-y-3 mb-6">
                  {[
                    ...
                    <div key={item.icon} className="bg-white/5 rounded-xl p-4 flex items-start gap-3">
                      <span className="material-symbols-outlined text-[#A85860] text-sm shrink-0 mt-0.5">{item.icon}</span>
                ...
                <div className="space-y-3">
                  <div className="bg-[#A85860]/20 rounded-xl p-4 border border-[#A85860]/30">
                    <p className="text-sm"><span className="font-bold text-white">Option A:</span> <span className="text-[#dadadc]/90">Full price counter at $2.05M, standard terms</span> <span className="text-[#A85860] font-bold">→ nets $1.82M after tax</span></p>
                  </div>
        ...
        <section className="mb-24">
          <ScrollReveal>
            <div className="mb-12">
              <span className="text-[#A85860] font-bold uppercase tracking-widest text-xs block mb-3">Exit Structures</span>
          ...
          <ScrollReveal delay={0.2}>
            <div className={`mt-8 rounded-2xl p-6 flex items-start gap-4 ${dark ? 'bg-[#A85860]/10 border border-[#A85860]/20' : 'bg-[#A85860]/5 border border-[#A85860]/15'}`}>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <ScrollReveal className="lg:col-span-5">
              <span className="text-[#A85860] font-bold uppercase tracking-widest text-xs block mb-3">Value Readiness</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={factor.title} className={`rounded-2xl p-6 ${dark ? 'bg-[#2f3133] border border-zinc-800' : 'bg-white border border-[#eeeef0]'}`}>
                    <span className="material-symbols-outlined text-[#A85860] text-xl mb-2">{factor.icon}</span>
                ...
                <div className={`sm:col-span-2 rounded-2xl p-6 ${dark ? 'bg-[#2f3133] border border-zinc-800' : 'bg-[#f3f3f6] border border-[#eeeef0]'}`}>
                  <span className="material-symbols-outlined text-[#A85860] text-xl mb-2">shield</span>
        ...
        <ScrollReveal>
          <section className="mb-24">
            <div className="mb-12">
              <span className="text-[#A85860] font-bold uppercase tracking-widest text-xs block mb-3">Your Deal Team</span>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className={dark ? 'bg-[#2f3133]' : 'bg-[#f3f3f6]'}>
                    ...
                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-widest text-[#A85860]">What Yulia does</th>
