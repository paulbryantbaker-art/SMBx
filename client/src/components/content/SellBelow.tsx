...
export default function SellBelow({ onChipClick }: SellBelowProps) {
  return (
    <div>
      {/* ═══ Block 1 — Starting point [FullBleed tinted] ═══ */}
      ...
      <section className="px-6" style={{ paddingTop: '140px' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <ScrollReveal delay={0.2}>
            <p style={{ fontSize: '16px', fontWeight: 400, color: 'rgba(26,26,24,0.5)', marginTop: 40, lineHeight: 1.65 }}>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <ScrollReveal delay={0.15}>
            <BeforeAfterSlider
              ...
              beforeContent={
                <div style={{ background: '#FAFAFA', padding: '32px', minHeight: 260 }}>
      ...
      {/* ═══ Block 6 — Entity types [BentoGrid] ═══ */}
      <section className="px-6" style={{ paddingTop: '140px' }}>
        <div className="max-w-4xl mx-auto">
          <ScrollReveal>
      ...
      {/* ═══ Block 7 — Pre-sale tax planning [FeatureGrid 3-col] ═══ */}
      <section className="px-6" style={{ paddingTop: '140px' }}>
        <div className="max-w-4xl mx-auto">
          <ScrollReveal>
      ...
      {/* ═══ Block 8 — Negotiation intelligence [NumberedList] ═══ */}
      <section className="px-6" style={{ paddingTop: '140px' }}>
        <div className="max-w-4xl mx-auto">
          <ScrollReveal>
      ...
      {/* ═══ Block 9 — Legal preparation [BentoGrid] ═══ */}
      <section className="px-6" style={{ paddingTop: '140px' }}>
        <div className="max-w-4xl mx-auto">
          <ScrollReveal>
      ...
      {/* ═══ Block 10 — For advisors [FullBleed] ═══ */}
      <FullBleedSection className="mt-20">
        <ScrollReveal>
      ...
      {/* ═══ Block 11 — The payoff + PullQuote + CTA ═══ */}
      <section className="px-6" style={{ paddingTop: '60px', paddingBottom: '80px' }}>
        <div className="max-w-4xl mx-auto">
          <PullQuote text="The wire hits your account. And you know." />
