  ...
  return (
    <div className="px-6">
        ...
        <div style={sectionStyle}>
          ...
          <RevealSection style={{ marginTop: 32 }}>
            <div className="space-y-6" style={bodyStyle}>
              <p>Every business owner has a moment. It might come at 2am, or in a conversation with a spouse, or when a competitor gets acquired for a number that makes their jaw drop.</p>
              <p>The moment is: &ldquo;What is my business actually worth?&rdquo;</p>
              <p>And then &mdash; silence. The broker wants the listing. The CPA knows the taxes, not the market. Google returns articles from 2019. Nobody gives you a real number without an agenda.</p>
              <p>Yulia does. Tell her your industry, location, and revenue. She&apos;ll give you a valuation range built on live federal data &mdash; Census business counts, BLS wage benchmarks, SBA lending patterns, and real transaction multiples for your sector and geography.</p>
              <p>Your Bizestimate updates every quarter. Share the link with your partner, your CPA, your attorney &mdash; anyone who needs to see the number.</p>
              <p style={{ color: '#1A1A18', fontWeight: 600 }}>Most business owners have never seen a real number for what their company is worth. You can have one in 90 seconds.</p>
            </div>
          </RevealSection>
        </div>
      </section>
      ...
      <section style={{ paddingTop: 140 }}>
        <div style={sectionStyle}>
          <RevealSection>
            <span style={labelStyle}>ADD-BACK ANALYSIS &middot; EXAMPLE</span>
            <h2 style={h2Style} className="md:text-[48px]">
      ...
      {/* ═══ Block 3 — Exit options ═══ */}
      <section style={{ paddingTop: 140 }}>
        <div style={sectionStyle}>
          <RevealSection>
            <span style={labelStyle}>EXIT OPTIONS</span>
            <h2 style={h2Style} className="md:text-[48px]">
          ...
          <div className="space-y-10" style={{ marginTop: 40 }}>
            {[
              ...
              { title: 'Buy Out a Partner', body: 'One of you wants out. A number both sides trust, financing that works, a buyout agreement that protects everyone.' },
              ...
              { title: 'Partial Sale', body: 'Sell majority to PE. Bring on a strategic partner. Take chips off the table while keeping upside.' },
            ].map((item, i) => (
      ...
      {/* ═══ Block 4 — Animated Seller Journey Timeline ═══ */}
      <section style={{ paddingTop: 140 }}>
        <div style={sectionStyle}>
          <RevealSection>
            <span style={labelStyle}>SELLER JOURNEY &middot; GUIDED PROCESS</span>
            <h2 style={h2Style} className="md:text-[48px]">
      ...
      <section style={{ paddingTop: 140 }}>
        <div style={sectionStyle}>
          <RevealSection>
            <span style={labelStyle}>TAX STRUCTURE ANALYSIS</span>
            <h2 style={h2Style} className="md:text-[48px]">
          ...
          <RevealSection style={{ marginTop: 40 }}>
            <span style={{ ...labelStyle, color: 'rgba(26,26,24,0.45)', display: 'block', marginBottom: 16 }}>SAME $2M DEAL &mdash; TWO STRUCTURES, TWO OUTCOMES</span>
            <BeforeAfterSlider
              beforeLabel="ASSET SALE"
              afterLabel="STOCK SALE"
              beforeContent={
                <div style={{ background: '#F5F3EF', padding: '32px', minHeight: 260 }}>
      ...
      {/* ═══ Block 6 — Entity types ═══ */}
      <section style={{ paddingTop: 140 }}>
        <div style={sectionStyle}>
          <RevealSection>
            <span style={labelStyle}>ENTITY TYPE &middot; WHAT YULIA CHECKS</span>
            <h2 style={h2Style} className="md:text-[48px]">
          ...
          <div className="space-y-4" style={{ marginTop: 40 }}>
            {[
              { title: 'C-Corporation \u2014 double taxation trap', body: 'Asset sales trigger TWO levels of tax: corporate level (21%) THEN shareholder level (up to 23.8%). Can cost $200K+ more than an S-Corp on the same deal. Yulia flags this immediately and explores alternatives: stock sale, \u00A7338(h)(10) election, or QSBS exclusion.' },
              { title: 'S-Corporation', body: 'Pass-through \u2014 no entity-level tax. But if you converted from a C-Corp in the last 5 years, built-in gains tax may apply. Yulia checks.' },
              { title: 'LLC / Partnership', body: 'Watch for \u00A7751 \u201Chot assets\u201D \u2014 inventory and receivables get taxed as ordinary income even in what looks like a capital gains transaction. A \u00A7754 election can give buyers a basis step-up inside a partnership interest sale.' },
              { title: 'Sole Proprietorship', body: 'Asset sale only. Straightforward, but allocation matters \u2014 non-compete income may trigger self-employment tax.' },
            ].map(item => (
              <RevealSection key={item.title}>
                <div style={cardStyle}>
      ...
      {/* ═══ Block 7 — Pre-sale tax planning ═══ */}
      <section style={{ paddingTop: 140 }}>
        <div style={sectionStyle}>
          <RevealSection>
            <span style={labelStyle}>PRE-SALE TAX PLANNING</span>
            <h2 style={h2Style} className="md:text-[48px]">
          ...
          <div className="space-y-4" style={{ marginTop: 40 }}>
            {[
              { title: 'Entity conversion (C\u2192S-Corp)', body: 'Eliminates double taxation, but requires a 5-year waiting period for built-in gains tax to expire.' },
              { title: 'Installment sale structuring', body: 'Seller financing spreads gain recognition over the payment period, potentially keeping you in lower brackets each year.' },
              { title: 'QSBS screening (C-Corps only)', body: 'IRC \u00A71202 can exclude up to $10M in federal capital gains. Requires original issuance stock, 5+ year holding period, and <$50M gross assets.' },
              { title: 'Purchase price allocation', body: 'Maximize goodwill (capital gains) and minimize ordinary income items before negotiation.' },
              { title: 'Opportunity Zone reinvestment', body: 'Within 180 days of close, reinvesting in a qualified OZ fund can defer and reduce capital gains.' },
              { title: 'Harvest losses in year of sale', body: 'Sell losing investments to offset deal gains dollar-for-dollar.' },
            ].map(item => (
              <RevealSection key={item.title}>
                <div style={cardStyle}>
      ...
      {/* ═══ Block 8 — Negotiation intelligence ═══ */}
      <section style={{ paddingTop: 140 }}>
        <div style={sectionStyle}>
          <RevealSection>
            ...
            <p style={{ ...bodyStyle, marginTop: 16 }}>Yulia levels the field:</p>
          </RevealSection>
      ...
      <section style={{ paddingTop: 140 }}>
        <div style={sectionStyle}>
          ...
          <div className="space-y-4" style={{ marginTop: 40 }}>
            {[
              { title: 'Reps & warranties', body: 'Your factual statements about the business. If one turns out false, the buyer can claw back money through indemnification. Yulia identifies which reps matter most for your industry and flags the language traps \u2014 like the difference between \u201Cto Seller\u2019s knowledge\u201D and \u201Cto Seller\u2019s knowledge after reasonable inquiry.\u201D' },
              { title: 'Indemnification & escrow', body: 'Typically 5\u201315% of the purchase price is held in escrow for 12\u201318 months after closing to cover claims. That\u2019s cash you don\u2019t receive at close. Yulia models the escrow impact on your actual take-home and recommends negotiation targets for basket, cap, and escrow duration.' },
              { title: 'Non-compete terms', body: 'Standard 2\u20135 years, but enforceability varies dramatically by state. California generally doesn\u2019t enforce non-competes \u2014 except for the sale of a business. Texas and Florida enforce broadly. Yulia checks your state and flags what\u2019s reasonable.' },
              { title: 'Lease assignment', body: 'If the business depends on a location, the landlord must approve the transfer. They\u2019ll likely want higher rent, a personal guarantee from the buyer, or both. Yulia flags this early \u2014 it\u2019s a hidden deal-killer if handled too late.' },
              { title: 'Regulatory & license transfers', body: 'Healthcare, childcare, construction, pest control, food service \u2014 many industries require new license applications from the buyer. Some take 3\u20136 months. Yulia checks your industry and builds the timeline.' },
            ].map(item => (
              <RevealSection key={item.title}>
                <div style={cardStyle}>
                  <h3 style={{ fontSize: '16px', fontWeight: 600, color: '#1A1A18', margin: '0 0 8px' }}>{item.title}</h3>
      ...
      {/* ═══ Block 10 — For advisors ═══ */}
      <section style={{ paddingTop: 140 }}>
        <div style={sectionStyle}>
          <RevealSection>
            <span style={labelStyle}>FOR ADVISORS</span>
            <h2 style={h2Style} className="md:text-[48px]">
          ...
          <RevealSection style={{ marginTop: 32 }}>
            <div className="space-y-6" style={bodyStyle}>
              ...
              <p>Your broker focuses on relationships and negotiations. Yulia handles the data. Together, it&apos;s the best of both worlds &mdash; the human judgment of a seasoned advisor backed by institutional-grade intelligence.</p>
      ...
      <section style={{ paddingTop: 100, paddingBottom: 80 }}>
        <div style={sectionStyle}>
          ...
          <RevealSection>
            <div className="space-y-6" style={bodyStyle}>
              <p>Not &ldquo;I hope I got a fair deal.&rdquo; Not &ldquo;I wonder if I left money on the table.&rdquo; Not &ldquo;I wish I&apos;d started this sooner.&rdquo;</p>
              <p>You know your number was real. You know your add-backs were captured. You know your CIM was institutional quality. You know the tax structure was modeled. You know the negotiation was prepared, not improvised.</p>
              <p style={{ color: '#1A1A18', fontWeight: 600 }}>That&apos;s what Yulia delivers: the confidence that comes from knowing &mdash; at every stage &mdash; that you made the right moves.</p>
            </div>
          </RevealSection>
