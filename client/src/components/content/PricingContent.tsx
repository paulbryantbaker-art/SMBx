...
export default function PricingContent() {
  ...
  return (
    <div className="bg-[#FDFCFB] text-[#1A1A18] font-sans relative selection:bg-[#D4714E] selection:text-white overflow-x-hidden">
      ...
      {/* --- 2. HERO TEXT (collapses via grid-rows) --- */}
      <div
        className="grid transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
        style={{ gridTemplateRows: viewState === 'landing' ? '1fr' : '0fr' }}
      >
        <div className="overflow-hidden">
          <div className="w-full max-w-5xl mx-auto px-6 flex flex-col items-center text-center pt-[22vh] md:pt-[28vh]">
      ...
      {/* --- 3. GRAVITY WELL (single ChatComposer morphs between hero & dock) --- */}
      <div className={`w-full transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
        ...
        <div className={`mx-auto w-full transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
          viewState === 'chat' ? 'max-w-[800px] pointer-events-auto' : 'max-w-[800px]'
        }`}>
          <ChatComposer
            value={inputValue}
        ...
        {/* Chips collapse inside gravity well */}
        <div
          className="grid transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
          style={{ gridTemplateRows: viewState === 'landing' ? '1fr' : '0fr' }}
        >
          <div className="overflow-hidden">
            <div className="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto mt-8 mb-2">
            ...
            <div className="text-center text-[13px] font-bold text-[#A9A49C] uppercase tracking-widest mt-4 pb-2">
      ...
      {/* --- 5. BELOW-FOLD MARKETING CONTENT (collapses via grid-rows) --- */}
      <div
        className="grid transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]"
        style={{ gridTemplateRows: viewState === 'landing' ? '1fr' : '0fr' }}
      >
