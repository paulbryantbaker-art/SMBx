    ...
    <div className={dark ? 'bg-transparent text-[#f9f9fc]' : 'bg-transparent text-[#1a1c1e]'}>
      <div className="pt-12 pb-24 px-6 md:px-12 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-7">
            <ScrollReveal>
              <div className="flex items-center gap-2 mb-8">
                <span className="inline-block px-3 py-1 bg-[#C25572]/10 text-[#C25572] text-[10px] font-black uppercase tracking-[0.2em] rounded-sm">Raise</span>
            ...
            <ScrollReveal y={40} delay={0.1}>
              <h1 className="font-headline font-black text-5xl md:text-6xl tracking-tighter leading-[0.92] mb-8">
                More than half of search fund operators <span className="text-[#C25572]">never acquire.</span> Most fundraising decks never get a second meeting.
              </h1>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <div className={`space-y-6 text-xl editorial max-w-xl ${dark ? 'text-[#dadadc]/80' : 'text-[#5d5e61]'}`}>
                ...
                <p className={`font-bold border-l-4 border-[#C25572] pl-6 text-2xl italic ${dark ? 'text-[#f9f9fc]' : 'text-[#1a1c1e]'}`}>Yulia builds your fundraising package. You take the meetings.</p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <ScrollReveal className="lg:col-span-5">
              <span className="text-[#C25572] font-bold uppercase tracking-widest text-xs block mb-3">Your Raise Process</span>
              <h2 className="text-4xl font-headline font-black tracking-tight mb-8">Six gates from readiness to close.</h2>
              <p className={`font-bold text-xl border-l-4 border-[#C25572] pl-6 italic mb-8 ${dark ? 'text-[#f9f9fc]' : 'text-[#1a1c1e]'}`}>Every gate has specific completion triggers. Yulia advances you when the prerequisite work is done — and not before.</p>
              ...
              {[
                ...
                <StaggerItem key={step.num}>
                  <div className={`rounded-2xl p-6 flex items-start gap-4 ${dark ? 'bg-[#2f3133] border border-zinc-800' : 'bg-white border border-[#eeeef0]'}`}>
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold shrink-0 ${step.free ? (dark ? 'bg-[#006630]/20 text-[#006630]' : 'bg-[#006630]/10 text-[#006630]') : 'bg-[#C25572]/10 text-[#C25572]'}`}>{step.num}</div>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <ScrollReveal className="lg:col-span-5">
              <span className="text-[#C25572] font-bold uppercase tracking-widest text-xs block mb-3">Dilution Intelligence</span>
                ...
                <div className="mb-6">
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <div className="bg-white/5 rounded-xl p-4 border border-white/10 text-center">
                      ...
                      <p className="text-xl font-black text-[#C25572]">$2M</p>
                    </div>
                    <div className="bg-white/5 rounded-xl p-4 border border-white/10 text-center">
        ...
        <section className="mb-24">
          <ScrollReveal>
            <div className="mb-12">
              <span className="text-[#C25572] font-bold uppercase tracking-widest text-xs block mb-3">Capital Options</span>
