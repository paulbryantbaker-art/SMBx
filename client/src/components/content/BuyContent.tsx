        ...
        <div className="overflow-hidden">
          <div className="border-t border-[#EAE6DF]">
              ...
              <div className="max-w-6xl mx-auto">
                <div className="mb-16 md:flex justify-between items-end gap-8">
                  <div className="max-w-2xl">
                    ...
                    <p className="text-[#6E6A63] text-lg leading-relaxed">The smbX.ai Engine evaluates targets, maps the competitive landscape, and runs live financing math so you know exactly what you&apos;re buying into before you write a check.</p>
                  </div>
                  <div className="mt-8 md:mt-0 flex items-center gap-4 bg-white px-6 py-5 rounded-2xl border border-[#EAE6DF] shadow-sm">
                    ...
                    <div><div className="text-xs text-[#A9A49C] uppercase tracking-wider font-bold">Financial Engine</div><div className="font-bold text-lg text-[#1A1A18]">Deal Feasibility</div></div>
                  </div>
                </div>
                <div className="grid md:grid-cols-3 gap-4 md:gap-6">
                  <div className="md:col-span-2 bg-white rounded-3xl p-8 border border-[#EAE6DF] shadow-sm"><h3 className="text-2xl font-bold mb-4">Instant SBA Bankability &amp; DSCR</h3><p className="text-[#6E6A63] mb-8 max-w-lg leading-relaxed">SBA financing feasibility, debt service coverage ratios (DSCR), and cash-on-cash return projections modeled side-by-side using live federal rates.</p><div className="flex flex-wrap gap-2"><Badge text="DSCR Analysis" /><Badge text="Cash-on-Cash Return" /><Badge text="SBA 7(a) Modeling" /></div></div>
                  <div className="bg-white rounded-3xl p-8 border border-[#EAE6DF] shadow-sm flex flex-col"><div className="w-12 h-12 bg-[#F8F6F1] rounded-xl flex items-center justify-center text-[#D4714E] font-black text-xl mb-6">01</div><h3 className="text-xl font-bold mb-3">Target Evaluation</h3><p className="text-[#6E6A63] text-sm leading-relaxed mt-auto">Valuation benchmarking against comparable transactions and red-flag identification. Know if the asking price is justified.</p></div>
                  <div className="bg-white rounded-3xl p-8 border border-[#EAE6DF] shadow-sm flex flex-col md:col-span-3 lg:col-span-1"><div className="w-12 h-12 bg-[#F8F6F1] rounded-xl flex items-center justify-center text-[#D4714E] font-black text-xl mb-6">02</div><h3 className="text-xl font-bold mb-3">Market Intelligence</h3><p className="text-[#6E6A63] text-sm leading-relaxed mt-auto">Industry landscape, competitive density, and consolidation activity in your target sector.</p></div>
                  <div className="bg-[#D4714E] rounded-3xl p-8 flex items-center justify-between md:col-span-2 text-white shadow-md"><div className="max-w-lg"><h3 className="text-3xl font-bold mb-3">Deal structuring and optimization.</h3><p className="text-orange-100 font-medium leading-relaxed">Understand the levers that get a deal done. We model earnouts, seller financing scenarios, equity rolls, and working capital pegs automatically.</p></div></div>
                </div>
              </div>
            </section>

            <section className="px-6 py-24 max-w-5xl mx-auto w-full">
              <div className="text-center mb-16"><h2 className="text-4xl font-bold mb-4">The numbers behind the decision</h2><p className="text-[#6E6A63] text-lg">See how Yulia instantly models SBA bankability and debt service coverage.</p></div>
              <div className="bg-[#F8F6F1] rounded-[40px] p-6 md:p-10 border border-[#EAE6DF] shadow-xl max-w-4xl mx-auto">
                <div className="flex flex-col gap-6">
                  <div className="self-end bg-[#D4714E] text-white p-6 rounded-[24px] rounded-br-[8px] max-w-[85%] md:max-w-[75%] shadow-md text-[16px] leading-relaxed">I found a commercial landscaping business asking $2.4M. SDE is $600K. I have $250K liquid for a down payment. Can I finance this with an SBA loan?</div>
                  <div className="self-start flex gap-4 max-w-[95%] md:max-w-[85%]">
                    ...
                    <div className="bg-white border border-[#EAE6DF] p-6 md:p-8 rounded-[24px] rounded-tl-[8px] shadow-md text-[#1A1A18] text-[16px] leading-relaxed">
                      ...
                      <div className="bg-[#FDFCFB] border border-[#EAE6DF] rounded-2xl p-6 mb-6 shadow-sm font-mono text-sm">
                        ...
                        <div className="flex justify-between pt-1 items-center"><span className="font-bold font-sans text-lg">DSCR:</span><div className="flex items-center gap-3"><span className="text-xs font-sans text-green-700 font-bold bg-green-50 px-2 py-1 rounded border border-green-100">Passes SBA Min (1.25x)</span><span className="font-bold text-[#D4714E] text-xl">1.80x</span></div></div>
                      </div>
                      <div className="space-y-4 text-[15px] mb-6">
                        <div className="flex items-start gap-3 bg-green-50/50 p-4 rounded-xl border border-green-100"><div className="mt-1 font-black text-green-600">&check;</div><div><strong>Good news:</strong> With a 1.80x DSCR, this comfortably beats the SBA&apos;s 1.25x minimum. Your $250K liquidity covers the 10% injection.</div></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="px-6 py-24 bg-white border-y border-[#EAE6DF]">
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16"><div className="text-sm font-bold text-[#A9A49C] uppercase tracking-widest mb-4">The Deliverables</div><h2 className="text-3xl md:text-4xl font-bold mb-4">What you actually walk away with.</h2><p className="text-[#6E6A63] text-lg max-w-2xl mx-auto">Yulia instantly generates the exact institutional-grade collateral you need to evaluate targets, secure funding, and close deals.</p></div>
            ...
            <section className="px-6 py-24 bg-[#F8F6F1] border-t border-[#EAE6DF]">
              <div className="max-w-4xl mx-auto">
                <div className="bg-white border border-[#EAE6DF] rounded-[40px] p-8 md:p-12 shadow-xl shadow-[#1A1A18]/5">
                  <div className="text-center mb-12"><h2 className="text-3xl md:text-4xl font-bold mb-6">Move with the speed of an institutional fund.</h2><p className="text-lg text-[#6E6A63] leading-relaxed">Whether you are a solo searcher evaluating your first acquisition or a platform running a buy-and-build strategy, smbX.ai scales with your thesis.</p></div>
