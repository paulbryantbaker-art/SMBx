    ...
    <div className={dark ? 'bg-transparent text-[#f9f9fc]' : 'bg-transparent text-[#1a1c1e]'}>
      <div className="pt-12 pb-24 px-6 md:px-12 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-7">
            <ScrollReveal>
              <div className="flex items-center gap-2 mb-8">
                <span className="inline-block px-3 py-1 bg-[#A85860]/10 text-[#A85860] text-[10px] font-black uppercase tracking-[0.2em] rounded-sm">Buy</span>
            ...
            <ScrollReveal y={40} delay={0.1}>
              <h1 className="font-headline font-black text-5xl md:text-6xl tracking-tighter leading-[0.92] mb-8">
                ...
                <span className="text-[#A85860]">You need to find them first.</span>
              </h1>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <div className={`space-y-6 text-xl editorial max-w-xl ${dark ? 'text-[#dadadc]/80' : 'text-[#5d5e61]'}`}>
                ...
                <p className={`font-bold border-l-4 border-[#A85860] pl-6 text-2xl italic ${dark ? 'text-[#f9f9fc]' : 'text-[#1a1c1e]'}`}>Yulia screens every deal against real market data before you spend a dollar.</p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <ScrollReveal className="lg:col-span-5">
              <span className="text-[#A85860] font-bold uppercase tracking-widest text-xs block mb-3">Your Acquisition Process</span>
        ...
        <section className="mb-24">
          <ScrollReveal>
            <div className="mb-12">
              <span className="text-[#A85860] font-bold uppercase tracking-widest text-xs block mb-3">Buyer Intelligence</span>
          ...
          <ScrollReveal delay={0.2}>
            <div className={`mt-8 rounded-2xl p-6 flex items-start gap-4 ${dark ? 'bg-[#A85860]/10 border border-[#A85860]/20' : 'bg-[#A85860]/5 border border-[#A85860]/15'}`}>
              <span className="material-symbols-outlined text-[#A85860] text-2xl shrink-0 mt-1">add_circle</span>
            ...
            <div className={`rounded-3xl overflow-hidden text-white ${dark ? 'bg-[#0f1012]' : 'bg-[#1a1c1e]'}`}>
              <div className="grid grid-cols-1 lg:grid-cols-12">
                ...
                <div className="lg:col-span-7 p-10 md:p-16">
                  <span className="text-[#A85860] font-bold uppercase tracking-widest text-xs block mb-3">Deal Economics</span>
                ...
                <div className="lg:col-span-5 bg-[#A85860] p-10 md:p-16 flex flex-col justify-center">
