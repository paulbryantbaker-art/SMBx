    ...
    <div className={dark ? 'bg-transparent text-[#f9f9fc]' : 'bg-transparent text-[#1a1c1e]'}>
      <div className="pt-12 pb-24 px-6 md:px-12 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-7">
            <ScrollReveal>
              <div className="flex items-center gap-2 mb-8">
                <span className="inline-block px-3 py-1 bg-[#C4687A]/10 text-[#C4687A] text-[10px] font-black uppercase tracking-[0.2em] rounded-sm">Advisors</span>
            ...
            <ScrollReveal y={40} delay={0.1}>
              <h1 className="font-headline font-black text-5xl md:text-6xl tracking-tighter leading-[0.92] mb-8">
                A CIM that takes you 40 hours takes Yulia <span className="text-[#C4687A]">two.</span>
              </h1>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <div className={`space-y-6 text-xl editorial max-w-xl ${muted}`}>
                ...
                <p className={`font-bold border-l-4 border-[#C4687A] pl-6 text-2xl italic ${emphasis}`}>Same platform. Same intelligence. Your superpower is that Yulia does 80% of the analytical work.</p>
              </div>
            </ScrollReveal>
          </div>
              ...
              <div className="space-y-5">
                {timeRows.map((row, i) => (
                  <div key={row.label} className="flex items-center gap-4">
                    <div className={`${i === 0 ? 'bg-[#C4687A]/20' : 'bg-white/5'} rounded-xl px-3 py-2 text-center min-w-[80px]`}>
                      <p className="text-[10px] text-[#dadadc]/60">Before</p>
                      <p className="font-bold text-[#dadadc]/90">{row.before}</p>
                    </div>
                    <span className="material-symbols-outlined text-[#C4687A]">arrow_forward</span>
                    <div className={`${i === 0 ? 'bg-[#C4687A]/20' : 'bg-white/5'} rounded-xl px-3 py-2 text-center min-w-[80px]`}>
                      <p className="text-[10px] text-[#dadadc]/60">With Yulia</p>
                      <p className="font-bold text-[#C4687A]">{row.after}</p>
                    </div>
        ...
        <ScrollReveal>
          <section className="mb-24">
            <div className={`${darkPanel} rounded-3xl p-10 md:p-16 text-white`}>
              <div className="mb-12">
                <span className="text-[#C4687A] font-bold uppercase tracking-widest text-xs block mb-3">The Leverage</span>
                ...
                {capabilities.map((c) => (
                  <StaggerItem key={c.title}>
                    <div className="bg-white/5 rounded-2xl border border-white/10 p-8 hover:bg-white/10 transition-colors h-full">
                      <span className="material-symbols-outlined text-[#C4687A] text-3xl mb-4">{c.icon}</span>
          ...
          <section className="mb-24">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
              <div className="lg:col-span-5">
                <span className="text-[#C4687A] font-bold uppercase tracking-widest text-xs block mb-3">Client Perception</span>
                ...
                <p className={`font-bold text-xl border-l-4 border-[#C4687A] pl-6 italic ${emphasis}`}>The CIM has your name on it. The valuation has your methodology. The deal runs on your relationships. Yulia just made it all possible in a fraction of the time.</p>
              </div>
              <div className="lg:col-span-7">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {perceptionCards.map((p) => (
                    <div key={p.title} className={`${card} rounded-2xl p-6 hover:shadow-lg transition-all`}>
                      <span className="material-symbols-outlined text-[#C4687A] text-xl mb-3">{p.icon}</span>
        ...
        <ScrollReveal>
          <section className="mb-24">
            <div className="mb-12">
              <span className="text-[#C4687A] font-bold uppercase tracking-widest text-xs block mb-3">Your Workflow</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {/* After */}
              <div className={`${dark ? 'bg-[#2f3133]' : 'bg-white'} rounded-2xl border-2 border-[#C4687A] p-8`}>
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-xl bg-[#C4687A]/10 flex items-center justify-center">
                    <span className="material-symbols-outlined text-[#C4687A]">bolt</span>
                  </div>
                  <h3 className="font-bold text-lg">With Yulia</h3>
                </div>
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3"><span className="text-[#C4687A] font-bold min-w-[48px]">60%</span><p className={`font-medium ${emphasis}`}>Client meetings, relationship building, deal sourcing</p></div>
                  <div className="flex items-start gap-3"><span className="text-[#C4687A] font-bold min-w-[48px]">15%</span><p className={muted}>Review Yulia's analysis, apply judgment, refine</p></div>
                  <div className="flex items-start gap-3"><span className="text-[#C4687A] font-bold min-w-[48px]">15%</span><p className={muted}>Oversee DD coordination (Yulia tracks the details)</p></div>
                  <div className="flex items-start gap-3"><span className="text-[#C4687A] font-bold min-w-[48px]">10%</span><p className={muted}>Review and send communications Yulia drafted</p></div>
                </div>
                <div className="mt-6 pt-4 border-t border-[#C4687A]/20">
                  <p className="text-sm font-bold text-[#C4687A]">15–20 active deals · 80% on relationships</p>
                </div>
              </div>
            </div>
          </section>
        ...
        <ScrollReveal>
          <section className="mb-24">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
              <div className="lg:col-span-5">
                <span className="text-[#C4687A] font-bold uppercase tracking-widest text-xs block mb-3">Pricing</span>
                ...
                <p className={`font-bold text-xl border-l-4 border-[#C4687A] pl-6 italic ${emphasis}`}>Try Professional free for 30 days. No credit card.</p>
              </div>
              <div className="lg:col-span-7">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {/* Professional */}
                  <div className={`${dark ? 'bg-[#2f3133]' : 'bg-white'} rounded-2xl border-2 border-[#C4687A] p-6 flex flex-col relative shadow-lg`}>
                    <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#C4687A] text-white text-[8px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">Solo Advisors</span>
                    <h4 className="font-black text-sm mb-2 mt-2">Professional</h4>
                    <p className="text-3xl font-black text-[#C4687A] mb-1">$149<span className={`text-sm font-medium ${muted}`}>/mo</span></p>
                    ...
                    <div className="space-y-2 flex-1">
                      {['Unlimited client engagements', 'All documents + analysis', 'Full methodology (22 gates)', 'Pipeline management'].map((f) => (
                        <div key={f} className="flex items-start gap-2">
                          <span className="material-symbols-outlined text-[#C4687A] text-sm shrink-0 mt-0.5">check_circle</span>
                          <p className={`text-xs ${muted}`}>{f}</p>
                        </div>
                      ))}
                    </div>
                    <button onClick={handleCTA} className="mt-6 w-full py-2.5 bg-gradient-to-r from-[#C4687A] to-[#E09098] text-white rounded-full font-bold text-xs hover:scale-[1.02] transition-all border-none cursor-pointer">Try Free for 30 Days</button>
                  </div>
                  {/* Enterprise */}
                  ...
                  {/* ROI card */}
                  <div className="bg-[#C4687A] rounded-2xl p-6 flex flex-col text-white">
        ...
        <ScrollReveal>
          <section className="mb-24">
            <div className="mb-12">
              <span className="text-[#C4687A] font-bold uppercase tracking-widest text-xs block mb-3">Who Uses This</span>
              ...
              {advisorTypes.map((a) => (
                <StaggerItem key={a.title}>
                  <div className={`${card} rounded-2xl p-8 hover:shadow-lg transition-all h-full`}>
                    <span className="material-symbols-outlined text-[#C4687A] text-2xl mb-3">{a.icon}</span>
        ...
        <ScrollReveal>
          <section className="mb-12">
            <div className={`${darkPanel} rounded-3xl p-12 md:p-16 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center text-white`}>
              <div>
                <h2 className="font-headline text-4xl md:text-5xl font-black tracking-tighter leading-[0.95]">Try Professional<br/><span className="text-[#C4687A]">free for 30 days.</span></h2>
              ...
              <div className="flex flex-col items-center lg:items-end gap-4">
                <button onClick={handleCTA} className="px-10 py-5 bg-gradient-to-r from-[#C4687A] to-[#E09098] text-white rounded-full font-black text-lg hover:scale-105 transition-all shadow-xl w-full lg:w-auto text-center border-none cursor-pointer">Start Free Trial</button>
