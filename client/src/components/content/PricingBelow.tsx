          ...
          <StaggerContainer className="space-y-4">
            {[
              ...
              <StaggerItem key={item.title}>
                <div className="flex items-start justify-between" style={{ background: '#F7F6F4', borderRadius: 16, border: '1px solid rgba(26,26,24,0.05)', padding: '20px 28px' }}>
                  ...
                  <PulseBadge color="#22C55E" style={{ flexShrink: 0 }}>{item.badge}</PulseBadge>
                </div>
              </StaggerItem>
            ))}
          </StaggerContainer>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <StaggerContainer className="space-y-4">
            {[
              ...
              <StaggerItem key={item.title}>
                <div className="flex items-start justify-between" style={{ background: '#F7F6F4', borderRadius: 16, border: '1px solid rgba(26,26,24,0.05)', padding: '20px 28px', transition: 'transform 0.2s, box-shadow 0.2s' }}>
                  <div className="flex-1 min-w-0 mr-4">
