      ...
      <div className="pt-12 pb-24 px-6 md:px-12 max-w-6xl mx-auto">
        ...
        <section className="mb-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
          <div className="lg:col-span-7">
            <ScrollReveal>
              <span className="inline-block px-3 py-1 bg-[#A85860]/10 text-[#A85860] text-[10px] font-black uppercase tracking-[0.2em] mb-8 rounded-sm">Pricing</span>
            </ScrollReveal>
            <ScrollReveal y={40} delay={0.1}>
              <h1 className="font-headline font-black text-5xl md:text-7xl tracking-tighter leading-[0.9] mb-8">
                Investment-grade deal intelligence.<br/><span className="text-[#A85860]">From $0.</span>
              </h1>
            </ScrollReveal>
          ...
          <ScrollReveal delay={0.25} className="lg:col-span-5">
            <div className={`rounded-2xl p-8 ${dark ? 'bg-[#2f3133]' : 'bg-[#f3f3f6]'}`}>
              ...
              <p className="text-5xl font-black text-[#A85860]">$149<span className={`text-lg font-medium ${muted}`}>/month</span></p>
            </div>
          </ScrollReveal>
        </section>
        ...
        <section className="mb-24">
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Professional */}
            <StaggerItem>
              <div className={`rounded-2xl border-2 border-[#A85860] p-8 flex flex-col h-full relative shadow-lg ${dark ? 'bg-[#2f3133]' : 'bg-white'}`}>
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#A85860] text-white text-[9px] font-bold px-4 py-1 rounded-full uppercase tracking-wider">Most Popular</span>
                <h3 className="font-black text-lg mb-1">Professional</h3>
                <p className="text-4xl font-black text-[#A85860] mb-1">$149<span className={`text-lg font-medium ${muted}`}>/mo</span></p>
                ...
                <button onClick={() => handleCTA()} className="mt-8 w-full py-3 bg-gradient-to-r from-[#A85860] to-[#D4848C] text-white rounded-full font-bold text-sm hover:scale-[1.02] transition-all shadow-md border-none cursor-pointer">Try Professional Free</button>
              </div>
            </StaggerItem>
            {/* Enterprise */}
            <StaggerItem>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className={dark ? 'bg-[#2f3133]' : 'bg-[#f3f3f6]'}>
                    ...
                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-widest text-[#A85860]">smbX.ai Professional</th>
                  </tr>
                </thead>
                <tbody className={`divide-y text-sm ${dark ? 'divide-zinc-800' : 'divide-[#eeeef0]'}`}>
                    ...
                    <tr key={deliverable}>
                      ...
                      <td className="px-6 py-4">
                        <span className="flex items-center gap-1.5">
                          <span className="material-symbols-outlined text-[#A85860] text-sm">check_circle</span>
                          {smbx}
                        </span>
                      </td>
                    </tr>
                  ...
                  <tr className={dark ? 'bg-[#2f3133]' : 'bg-[#f3f3f6]'}>
                    ...
                    <td className="px-6 py-4 font-bold text-[#A85860]">$1,788/year</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <div className={`mt-6 rounded-2xl p-6 flex items-start gap-4 ${dark ? 'bg-[#A85860]/10 border border-[#A85860]/20' : 'bg-[#A85860]/5 border border-[#A85860]/15'}`}>
              <span className="material-symbols-outlined text-[#A85860] text-2xl shrink-0 mt-1">info</span>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <ScrollReveal className="lg:col-span-5">
              <span className="text-[#A85860] font-bold uppercase tracking-widest text-xs block mb-3">Free Forever</span>
              ...
              <p className={`font-bold text-xl border-l-4 border-[#A85860] pl-6 italic ${dark ? 'text-[#f9f9fc]' : 'text-[#1a1c1e]'}`}>If you could Google it, it's free. The moment Yulia tells you something you can't find anywhere else — that's where the value starts.</p>
            </ScrollReveal>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <ScrollReveal className="lg:col-span-5">
              <div className="border-l-8 border-[#A85860] pl-8">
            ...
            <ScrollReveal delay={0.15} className="lg:col-span-7">
              <div className={`rounded-3xl p-8 shadow-sm ${card}`}>
                <div className="space-y-0">
                  ...
                  <div className="w-full border-t border-dashed border-[#A85860]/30 my-2" />
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-[#A85860]/5">
                    <div className="w-10 h-10 rounded-xl bg-[#A85860]/10 flex items-center justify-center text-[#A85860] font-bold shrink-0">4</div>
                    <div className="flex-1">
                      <p className="font-bold text-[#A85860]">Yulia suggests your plan</p>
                      <p className={`text-xs ${muted}`}>"Ready for the full valuation and deal materials? Here's what comes next."</p>
                    </div>
                    <span className="text-[10px] bg-[#A85860]/10 text-[#A85860] px-2 py-1 rounded font-bold">$49+</span>
                  </div>
                  <div className={`flex items-center gap-4 p-4 rounded-xl ${dark ? 'hover:bg-zinc-800' : 'hover:bg-[#f3f3f6]'} transition-all`}>
                    <div className="w-10 h-10 rounded-xl bg-[#A85860]/10 flex items-center justify-center text-[#A85860] font-bold shrink-0">5</div>
                    <div className="flex-1">
                    ...
                    <span className="text-[10px] bg-[#A85860]/10 text-[#A85860] px-2 py-1 rounded font-bold">ALL</span>
                  </div>
                </div>
              </div>
            </ScrollReveal>
        ...
        <ScrollReveal>
          <section className="mb-24">
            <div className={`rounded-3xl p-10 md:p-16 text-white ${darkPanel}`}>
              <div className="mb-12">
                <span className="text-[#A85860] font-bold uppercase tracking-widest text-xs block mb-3">Professional Plan</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={item.title} className="bg-white/5 rounded-2xl border border-white/10 p-6">
                    <span className="material-symbols-outlined text-[#A85860] text-2xl mb-3">{item.icon}</span>
        ...
        <ScrollReveal>
          <section className="mb-12">
            <div className={`rounded-3xl p-12 md:p-16 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center text-white ${darkPanel}`}>
              <div>
                <h2 className="text-4xl md:text-5xl font-headline font-black tracking-tighter leading-[0.95]">Free until you<br/>see the <span className="text-[#A85860]">value.</span></h2>
