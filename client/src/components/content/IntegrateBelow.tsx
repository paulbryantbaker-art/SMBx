          ...
          <div className="lg:col-span-7">
            ...
            <ScrollReveal y={40} delay={0.1}>
              <h1 className="font-headline font-black text-5xl md:text-6xl tracking-tighter leading-[0.92] mb-8">
                The first 180 days determine <span className="text-[#D44A78]">everything.</span>
              </h1>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <div className={`space-y-6 text-xl editorial max-w-xl ${dark ? 'text-[#dadadc]/80' : 'text-[#5d5e61]'}`}>
                ...
                <p className={`font-bold border-l-4 border-[#D44A78] pl-6 text-2xl italic ${dark ? 'text-[#f9f9fc]' : 'text-[#1a1c1e]'}`}>Yulia builds your value creation plan from what due diligence actually revealed. Not a template. Your plan.</p>
              </div>
            </ScrollReveal>
          </div>
              ...
              <StaggerItem key={p.phase}>
                <div className={`rounded-2xl p-8 hover:shadow-lg transition-all ${dark ? 'bg-[#2f3133] border border-zinc-800' : 'bg-white border border-[#eeeef0]'}`}>
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-[#D44A78] font-bold text-xs uppercase tracking-widest">Phase {p.phase}</span>
                    <span className="text-[10px] bg-[#D44A78]/10 text-[#D44A78] px-2 py-1 rounded font-bold">{p.time}</span>
                  </div>
                  ...
                  <div className={`h-1.5 rounded-full overflow-hidden ${dark ? 'bg-zinc-700' : 'bg-[#f3f3f6]'}`}>
                    <div className="h-full bg-[#D44A78] rounded-full" style={{ width: `${p.progress}%` }} />
                  </div>
                </div>
              </StaggerItem>
            ))}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={metric.title} className={`rounded-2xl p-6 ${dark ? 'bg-[#2f3133] border border-zinc-800' : 'bg-white border border-[#eeeef0]'}`}>
                    <span className="material-symbols-outlined text-[#D44A78] text-xl mb-3">{metric.icon}</span>
                ...
                <div className={`sm:col-span-2 rounded-2xl p-6 ${dark ? 'bg-[#2f3133] border border-zinc-800' : 'bg-white border border-[#eeeef0]'}`}>
                  <span className="material-symbols-outlined text-[#D44A78] text-xl mb-3">handshake</span>
