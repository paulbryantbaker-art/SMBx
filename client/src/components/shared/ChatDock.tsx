        ...
        >
          ...
          <button
            ...
            style={{
              ...
              background: hasContent && !disabled ? '#C25572' : '#1a1c1e',
              color: '#fff',
      ...
      <div className="max-w-[860px] mx-auto pb-3 pt-2 lg:pb-4">
        <div className="home-dock-card relative">
          ...
          {attachment && (
            <div className="flex flex-wrap gap-2 px-4 pt-3 pb-0">
              <div className="flex items-center gap-1.5 px-2.5 py-1 bg-[#F5F5F5] rounded-lg max-w-[260px]">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#C25572" strokeWidth="2" strokeLinecap="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /></svg>
          ...
          <div className="flex items-center justify-between px-3 pb-3 pt-0">
            ...
            >
              {uploading ? (
                <div className="w-4 h-4 border-2 border-[#C25572] border-t-transparent rounded-full" style={{ animation: 'spin 1s linear infinite' }} />
              ) : (
            ...
            <button
              ...
              style={{
                ...
                background: hasContent && !disabled ? '#C25572' : '#eeeef0',
