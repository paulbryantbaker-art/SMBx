...
export const M = {
   ...
   *  a fixed child — Safari toolbar rule). NEUTRAL near-white, matching
   *  T.page — sampled from the Claude mobile app at Paul's direction ("the
   *  background should be this color"; the warm bone attempts read too
   *  dark). Separation is by TONE — white cards and the floating nav read
   *  as raised on it, the Cash App way. */
  frameBg: "#F9F9F9",
  glassNav,
  glassSheet,
} as const;
