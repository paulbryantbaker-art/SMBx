...
const S: Record<string, CSSProperties> = {
  ...
  emptyTitle: { fontSize: 19, fontWeight: 700, color: T.ink, marginTop: 2 },
  emptySub: { fontSize: 14, lineHeight: 1.5, color: T.muted, marginBottom: 6 },
  starterRow: {
    display: "flex",
    flexWrap: "wrap",
  ...
  yuliaText: { fontSize: 15.5, lineHeight: 1.62, color: "#1a1a1c", whiteSpace: "pre-wrap", minWidth: 0 },
  errorBubble: {
    padding: "10px 14px",
  ...
  thinking: { fontSize: 15, color: T.muted },
  trace: {
    display: "flex",
    flexDirection: "column",
    gap: 4,
