...
const COMPOSER_HINT: Record<AtlasScreen, string> = {
  ...
  targets: "Ask about the origination pipeline",
  people: "Ask about a contact",
  companies: "Ask about a firm on file",
  reports: "Ask what the numbers say",
  posting: "Ask about the campaign or a slot",
...
const SUGGESTIONS: Record<AtlasScreen, string[]> = {
  ...
  targets: ["Which targets stalled", "Who is ready for the IoI", "Summarise this wave", "What did the screen say"],
  people: ["Who do we know at this firm", "Who has no email", "Summarise this person's history", "Which roles are missing"],
  companies: ["What kinds are on file", "Which firms are do-not-pitch", "Summarise this firm", "Where does this one get worked"],
  reports: ["Why are we losing pursuits", "Which wave performs best", "Is activity up or down", "Read the funnel for me"],
  posting: ["What posts this week", "Which slots are undrafted", "What did the last Mandate carry", "When is DealSource"],
