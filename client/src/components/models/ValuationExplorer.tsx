    ...
    <div className="p-5 space-y-6 max-w-3xl mx-auto">
      ...
      {val && (
        <div className="rounded-xl p-4" style={{ background: '#FAF8F4', border: '1px solid #DDD9D1' }}>
          ...
          <div className="flex justify-between items-end mb-4 px-8">
            ...
            <div className="text-center">
              <p className="text-[9px] font-bold uppercase tracking-wider m-0 mb-1" style={{ color: '#B5636B' }}>Most Likely</p>
              <p className="text-2xl font-bold m-0" style={{ color: '#B5636B', fontFamily: 'Sora, sans-serif' }}>{centsToDisplay(val.mid)}</p>
            </div>
            <div className="text-center">
      ...
      {o.blended && (
        <div className="rounded-lg p-4" style={{ border: '1px solid #DDD9D1' }}>
          ...
          <p className="text-xl font-bold m-0" style={{ color: '#B5636B' }}>{centsToDisplay(o.blended.blended)}</p>
