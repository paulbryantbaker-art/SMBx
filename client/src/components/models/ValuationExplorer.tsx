    ...
    <div className="p-5 space-y-6 max-w-3xl mx-auto">
      ...
      {val && (
        <div className="rounded-xl p-4" style={{ background: 'var(--m-surface-container)', border: '1px solid var(--m-outline-var)' }}>
          ...
          <div className="flex justify-between items-end mb-4 px-2 sm:px-8">
            ...
            <div className="text-center">
              <p className="text-[9px] font-bold uppercase tracking-wider m-0 mb-1" style={{ color: '#2E8C5A' }}>Most Likely</p>
              <p className="text-2xl font-bold m-0" style={{ color: '#2E8C5A', fontFamily: 'var(--font-mono)', fontVariantNumeric: 'tabular-nums' }}>{centsToDisplay(val.mid)}</p>
            </div>
            <div className="text-center">
      ...
      {o.blended && (
        <div className="rounded-lg p-4" style={{ border: '1px solid var(--m-outline-var)' }}>
          ...
          <p className="text-xl font-bold m-0" style={{ color: '#2E8C5A' }}>{centsToDisplay(o.blended.blended)}</p>
