    ...
    <div className="p-5 space-y-6 max-w-3xl mx-auto">
      ...
      {earnout && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <KPICard label="Expected Value" value={centsToDisplay(earnout.expectedValue)} color="#C4687A" sublabel="Probability-weighted" />
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <button onClick={addMilestone} className="text-xs font-semibold px-3 py-1 rounded-full border-0 cursor-pointer" style={{ background: '#C4687A', color: 'white' }}>+ Add</button>
        </div>
