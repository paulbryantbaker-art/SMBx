    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      {!loading && deals.length > 0 && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
          ...
          <StatCard label="Sell" value={String(deals.filter(d => d.journey_type === 'sell').length)} color="#C4687A" />
          ...
          return (
            ...
            >
              <span
                ...
                style={{
                  background: isDone ? '#C4687A' : isCurrent ? 'rgba(186,60,96,0.15)' : 'rgba(0,0,0,0.06)',
                  color: isDone ? '#fff' : isCurrent ? '#C4687A' : 'rgba(0,0,0,0.3)',
                }}
              >
                {isDone ? (
