                ...
                <div className="flex items-center gap-2">
                  ...
                  {(user as any).email_verified ? (
                    ...
                    <button
                      ...
                      className="text-[10px] font-semibold text-[#C25572] bg-[#FFF0EB] px-2 py-1 rounded-lg border border-[#F5D5C8] cursor-pointer hover:bg-[#FFE8DF] transition-colors whitespace-nowrap disabled:opacity-50"
                    >
          ...
          {usageLoading ? (
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              ...
              <div className="bg-[#FAFAFA] rounded-xl p-3">
                ...
                <p className="text-base font-bold text-[#C25572] m-0">{usageTotals?.total_deliverables || 0}</p>
              </div>
              <div className="bg-[#FAFAFA] rounded-xl p-3">
                ...
                <div key={i} className="bg-[#FAFAFA] rounded-2xl p-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-base font-bold text-[#C25572] m-0">{b.median_multiple}x</p>
                    </div>
                    <div>
