          ...
          <div className="bg-[#FAFAFA] rounded-2xl p-4 mb-4">
            ...
            <div className="space-y-2.5">
              ...
              <button
                ...
                className="w-full py-1.5 rounded-xl text-sm font-semibold bg-[#C4687A] text-white border-0 cursor-pointer hover:bg-[#A85568] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                        ...
                        {overview.cbpData.sizeBreakdown.map((sz: any, i: number) => (
                          <div key={i} className="flex items-center gap-2">
                            ...
                            <div className="flex-1 h-1.5 bg-white rounded-full overflow-hidden">
                              <div className="h-full bg-[#C4687A] rounded-full" style={{ width: `${sz.pct || 0}%` }} />
                            </div>
