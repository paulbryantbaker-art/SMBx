          ...
          <div className="bg-[#FAFAFA] rounded-2xl p-4 mb-4">
            ...
            <div className="space-y-2.5">
              ...
              <button
                ...
                className="w-full py-1.5 rounded-xl text-sm font-semibold bg-[#B5636B] text-white border-0 cursor-pointer hover:bg-[#9A5058] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
