        ...
        <div className="px-6 pt-6 pb-4">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-[#FFF0EB] flex items-center justify-center shrink-0">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#B5636B" strokeWidth="2">
        ...
        <div className="px-6 py-5">
          <label className="flex items-start gap-3 cursor-pointer mb-4">
            <input
              ...
              className="mt-0.5 w-4 h-4 rounded accent-[#B5636B] cursor-pointer"
            />
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex-1 py-2.5 rounded-lg text-sm font-semibold text-white bg-[#B5636B] border-0 cursor-pointer hover:bg-[#9A5058] transition-colors disabled:opacity-40 disabled:cursor-default"
            >
