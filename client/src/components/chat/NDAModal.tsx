        ...
        <div className="px-6 pt-6 pb-4">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-[#FFF0EB] flex items-center justify-center shrink-0">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D4714E" strokeWidth="2">
                <rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0110 0v4" />
              </svg>
            </div>
            <div>
              <h2 className="text-lg font-bold text-[#1a1918] m-0">Non-Disclosure Agreement</h2>
              <p className="text-xs text-[#5e5d59] m-0 mt-0.5">Required before accessing deal materials</p>
            </div>
          </div>
        </div>

        {/* NDA Content */}
        <div className="px-6 py-4 bg-[#faf9f5] mx-6 rounded-lg max-h-[300px] overflow-y-auto text-[12px] leading-relaxed text-[#3d3d3a]" style={{ border: '1px solid #e8e6dc' }}>
          <p className="font-semibold text-[#1a1918] mb-3">CONFIDENTIALITY AND NON-DISCLOSURE AGREEMENT</p>
          ...
          <p className="font-semibold text-[#1a1918] mb-1">1. Confidential Information</p>
          <p className="mb-3">
          ...
          <p className="font-semibold text-[#1a1918] mb-1">2. Non-Disclosure</p>
          <p className="mb-3">
          ...
          <p className="font-semibold text-[#1a1918] mb-1">3. Permitted Use</p>
          <p className="mb-3">
          ...
          <p className="font-semibold text-[#1a1918] mb-1">4. No Contact</p>
          <p className="mb-3">
          ...
          <p className="font-semibold text-[#1a1918] mb-1">5. Return of Materials</p>
          <p className="mb-3">
          ...
          <p className="font-semibold text-[#1a1918] mb-1">6. Term</p>
          <p>
        ...
        <div className="px-6 py-5">
          <label className="flex items-start gap-3 cursor-pointer mb-4">
            <input
              ...
              className="mt-0.5 w-4 h-4 rounded accent-[#D4714E] cursor-pointer"
            />
            <span className="text-[12px] text-[#3d3d3a] leading-relaxed">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex-1 py-2.5 rounded-lg text-sm font-semibold text-white bg-[#D4714E] border-0 cursor-pointer hover:bg-[#B85A3A] transition-colors disabled:opacity-40 disabled:cursor-default"
            >
              {submitting ? 'Accepting...' : 'Accept NDA & Continue'}
            </button>
            <button
              onClick={onDecline}
              className="py-2.5 px-5 rounded-lg text-sm font-semibold text-[#5e5d59] bg-[#F5F5F5] border-0 cursor-pointer hover:bg-[#e8e6dc] transition-colors"
            >
              Decline
            </button>
          </div>
