...
export default function SourcingPanel({ isFullscreen }: SourcingPanelProps) {
  ...
  return (
    <div style={{ padding: isFullscreen ? '24px 40px' : 20 }}>
      ...
      {/* New Thesis Form */}
      {showNewThesis && (
        <div className="bg-[#FAFAFA] rounded-2xl border border-[#B5636B] p-4 mb-5">
          ...
          <div className="space-y-2.5 mb-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-1.5 rounded-lg border border-[rgba(0,0,0,0.08)] text-sm bg-white text-[#0D0D0D] outline-none focus:border-[#B5636B]"
              />
            </div>
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              ...
              className="px-4 py-1.5 rounded-xl text-xs font-semibold bg-[#B5636B] text-white border-0 cursor-pointer hover:bg-[#9A5058] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {theses.map(t => (
              <button
                ...
                className={`w-full text-left rounded-xl p-3 border transition-all cursor-pointer ${
                  selectedThesis === t.id
                    ? 'bg-[#FAFAFA] border-[#B5636B]'
                    : 'bg-[#FAFAFA] border-transparent hover:border-[#B5636B]'
                }`}
              >
                <div className="flex items-center gap-1.5 mb-0.5">
                  ...
                  {(t.total_matches || 0) > 0 && (
                    <span className="text-[9px] font-bold text-[#B5636B] bg-[#B5636B]/10 px-1.5 py-0.5 rounded-full">
              ...
              <div className="mb-4">
                {!portfolio && !pipelineRunning && (
                  <button
                    ...
                    className="w-full py-3 rounded-xl text-sm font-semibold bg-[#B5636B] text-white border-0 cursor-pointer hover:bg-[#9A5058] transition-colors flex items-center justify-center gap-2"
                  >
                ...
                {pipelineRunning && (
                  <div className="bg-[#FAFAFA] rounded-xl p-4 border border-[#B5636B]/20">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-4 h-4 border-2 border-[#B5636B] border-t-transparent rounded-full animate-spin" />
              ...
              {portfolio && portfolio.brief_status === 'complete' && (
                <div className="mb-5">
                  ...
                  {portfolio.pipeline_status !== 'ready' && portfolio.pipeline_status !== 'failed' && portfolio.pipeline_status !== 'initializing' && (
                    <div className="mt-3 bg-[#FAFAFA] rounded-xl p-3 border border-[#B5636B]/10">
                      <div className="flex items-center gap-2 mb-1.5">
                        <div className="w-3 h-3 border-2 border-[#B5636B] border-t-transparent rounded-full animate-spin" />
                      ...
                      {portfolio.stage_progress?.pct != null && (
                        <div className="w-full h-1.5 bg-[#EBE7DF] rounded-full overflow-hidden">
                          <div
                            className="h-full bg-[#B5636B] rounded-full transition-all duration-500"
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            {m.source_url && (
                              <a
                                ...
                                className="text-[10px] font-medium text-[#B5636B] hover:underline ml-auto"
                              >
                                View listing
                              </a>
                            )}
