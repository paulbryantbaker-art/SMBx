      ...
      {editing && (
        <div className="shrink-0 flex items-center gap-2 px-4 py-2" style={{ borderBottom: '1px solid #EBE7DF', backgroundColor: '#FAFAF8' }}>
          ...
          <button
            ...
            className="px-3 py-1 rounded-md text-[10px] font-semibold bg-[#B5636B] text-white border-0 cursor-pointer hover:bg-[#9A5058] disabled:opacity-40 transition-colors"
          >
