...
const variants: Record<Variant, string> = {
  primary:
    `${base} bg-[#D4714E] text-white border-none rounded-full text-[15px] font-semibold px-8 py-4 hover:bg-[#B85A3A] hover:-translate-y-px`,
  secondary:
    `${base} bg-transparent text-[#1a1918] border-2 border-[#E8E4DC] rounded-full text-[15px] font-semibold px-7 py-3.5 hover:border-[#1a1918]`,
  nav:
    `${base} bg-[#D4714E] text-white border-none rounded-full text-[13px] font-semibold py-2.5 px-[22px] hover:bg-[#B85A3A]`,
  cardLink:
