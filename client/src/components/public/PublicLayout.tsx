...
export default function PublicLayout({ children, minimal }: Props) {
  ...
  return (
    <div className={`flex flex-col bg-[#FAF8F4] ${isChat ? 'overflow-hidden' : 'min-h-dvh pt-28'}`} style={isChat ? { height: 'var(--app-height, 100dvh)', position: 'fixed', inset: 0 } : undefined}>
