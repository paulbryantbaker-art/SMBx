...
export default function PublicChatInput({
  ...
  return (
    <div className={className}>
      ...
      <div className="bg-white border-2 border-[#E8E4DC] rounded-[20px] p-2 shadow-[0_8px_40px_rgba(0,0,0,0.04)] transition-all duration-300 focus-within:border-[#C96B4F] focus-within:shadow-[0_8px_40px_rgba(218,119,86,0.1)]">
        <textarea
          ref={textareaRef}
          value={value}
        ...
        <div className="flex justify-between items-center px-3 pb-2 pt-1">
          ...
          <button
            ...
            className="w-10 h-10 rounded-xl bg-[#C96B4F] text-white flex items-center justify-center border-none cursor-pointer hover:bg-[#BE6342] transition-colors disabled:opacity-30 disabled:cursor-default"
            aria-label="Send"
          >
