...
export default function PublicChatMessage({ message }: Props) {
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="max-w-[80%] bg-white px-4 py-3" style={{ borderRadius: '20px 20px 20px 4px', border: '1px solid rgba(26,26,24,0.08)', boxShadow: '0 1px 3px rgba(26,26,24,0.04)' }}>
