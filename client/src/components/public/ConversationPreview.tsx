      ...
      <div className="px-7 py-7 flex flex-col gap-5">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="max-w-[75%] bg-[#FAFAFA] border border-[#FAFAFA] rounded-2xl rounded-bl-[4px] px-[18px] py-[14px]">
            <p className="text-sm leading-[1.55] m-0">
              Great &mdash; let me work with those numbers. Based on your revenue and owner compensation, I&apos;m calculating an adjusted EBITDA of approximately <span className="text-[#C4687A] font-semibold">$780K</span> after typical add-backs for owner-operated HVAC businesses.
            </p>
            <div className="mt-2.5 px-3.5 py-2.5 bg-[#FFF0EB] rounded-[10px]">
              <p className="text-[13px] text-[#A85568] leading-[1.5] m-0">
