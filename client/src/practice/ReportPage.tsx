  ...
  return (
    <PracticeShell footerCompact>
      ...
      <article className="rp">
        ...
        <section id="cta" className="ca-dark" style={{ background: '#1A1B19', color: '#F4F5F1', padding: 'clamp(110px, 10vw, 160px) 32px', marginTop: 'clamp(70px, 8vw, 120px)', position: 'relative', overflow: 'hidden' }}>
