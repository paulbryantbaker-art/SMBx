          ...
          <div data-lede style={{ display: 'grid', gridTemplateColumns: '400px 1fr', gap: 72, alignItems: 'start' }}>
            <div data-rv>
              ...
              <div style={{ marginTop: 32, position: 'relative', width: '100%', maxWidth: 360 }}>
                <img data-rvimg src="/founder-headshot-web.jpg" alt="Paul Baker, founder of smbX" style={{ display: 'block', width: '100%', aspectRatio: '4 / 5', objectFit: 'cover', objectPosition: '50% 24%' }} />
                <Handles />
