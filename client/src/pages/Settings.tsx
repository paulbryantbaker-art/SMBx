              ...
              {[7, 30, 90].map(d => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-sm font-medium border-0 cursor-pointer transition-colors ${
                    usageDays === d ? 'bg-[#C25572] text-white' : 'bg-[#F5F5F5] text-[#6E6A63] hover:bg-[#EBE7DF]'
                  }`}
                >
                  {d}d
                </button>
            ...
            {usageLoading ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                ...
                <div className="bg-white rounded-xl p-4 border border-border">
                  ...
                  <p className="text-lg font-bold text-[#C25572] m-0">{usageTotals?.total_deliverables || 0}</p>
                </div>
                <div className="bg-white rounded-xl p-4 border border-border">
                    ...
                    return (
                      <div key={d.date} className="flex items-center gap-3">
                        ...
                        <div className="flex-1 h-3 bg-[#F5F5F5] rounded-full overflow-hidden">
                          <div className="h-full bg-[#C25572] rounded-full transition-all" style={{ width: `${pct}%` }} />
                        </div>
                  ...
                  <div key={i} className="bg-white rounded-2xl border border-border p-5">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold text-[#C25572] m-0">{b.median_multiple}x</p>
                      </div>
                      <div>
