  ...
  return (
    <div className="min-h-dvh bg-[#FAFAFA]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        <h1 className="text-2xl font-extrabold text-[#0D0D0D] m-0 mb-6" style={{ fontFamily: "'General Sans', 'Inter', system-ui, sans-serif" }}>
          Settings
        </h1>
            ...
            {usageLoading ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                ...
                <div className="bg-white rounded-xl p-4 border border-border">
                  ...
                  <p className="text-lg font-bold text-[#C96B4F] m-0">{usageTotals?.total_deliverables || 0}</p>
                </div>
                <div className="bg-white rounded-xl p-4 border border-border">
                  ...
                  <div key={i} className="bg-white rounded-2xl border border-border p-5">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold text-[#C96B4F] m-0">{b.median_multiple}x</p>
                      </div>
                      <div>
