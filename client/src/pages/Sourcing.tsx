  ...
  return (
    <div className="min-h-dvh bg-[#FAFAFA]">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-[#FAFAFA]" style={{ borderBottom: '1px solid rgba(0,0,0,0.08)' }}>
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 text-sm text-[#6E6A63] bg-transparent border-0 cursor-pointer hover:text-[#C25572] transition-colors"
          >
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={onLogout} className="text-sm text-[#A9A49C] bg-transparent border-0 cursor-pointer hover:text-[#C25572] transition-colors">
            Sign out
          </button>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        {sellDeals.length > 0 && (
          <div className="mb-6">
            <button
              ...
              className="flex items-center gap-2 text-sm font-semibold text-[#C25572] bg-transparent border-0 cursor-pointer hover:underline mb-3"
            >
        ...
        {/* New Thesis Form */}
        {showNewThesis && (
          <div className="bg-white rounded-2xl border border-[#C25572] p-5 mb-6">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="px-5 py-2 rounded-xl text-sm font-semibold bg-[#C25572] text-white border-0 cursor-pointer hover:bg-[#9E4860] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        {!loading && theses.length === 0 && !showNewThesis && (
          <div className="text-center py-16">
            ...
            <button
              onClick={() => setShowNewThesis(true)}
              className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-[#C25572] text-white border-0 cursor-pointer hover:bg-[#9E4860] transition-colors"
            >
              ...
              {theses.map(t => (
                <button
                  ...
                  className={`w-full text-left rounded-2xl p-4 border transition-all cursor-pointer ${
                    selectedThesis === t.id
                      ? 'bg-white border-[#C25572] shadow-sm'
                      : 'bg-white border-border hover:border-[#C25572]'
                  }`}
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {t.match_count > 0 && (
                      <span className="text-[10px] font-bold text-[#C25572] bg-[#C25572]/10 px-2 py-0.5 rounded-full">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {m.source_url && (
                              <a
                                ...
                                className="text-[11px] font-medium text-[#C25572] hover:underline ml-auto"
                              >
                                View listing
                              </a>
                            )}
