...
const PAGE_COPY: Record<TabId, {
  ...
  sell: {
    ...
    subtitle: 'Whether you\u2019re selling outright, buying out a partner, raising capital, or transitioning to employees \u2014 Yulia builds the intelligence and walks you through every step to a premium outcome.',
    chips: [
      "What's my business worth if I sell everything?",
      "My partner wants out \u2014 what are our options?",
      'I want to raise capital without giving up control',
      'Walk me through what a 12-month exit plan looks like',
    ],
    tagline: 'SDE Normalization \u00B7 Add-back Discovery \u00B7 Defensible Valuations',
    placeholder: 'Tell Yulia about your business and what you\u2019re thinking...',
  },
  buy: {
  ...
  advisors: {
    ...
    subtitle: 'Package listings in minutes. Qualify buyers instantly. Generate institutional-grade deliverables under your brand. The intelligence infrastructure of a full-service firm \u2014 in your pocket.',
    chips: [
  ...
  pricing: {
    ...
    subtitle: 'The conversation is free. The intelligence is free. When you need documents, pay per deliverable. No subscriptions. No retainers. No surprises.',
    chips: [
