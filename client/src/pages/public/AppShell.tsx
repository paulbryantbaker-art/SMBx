...
const PAGE_COPY: Record<TabId, PageCopy> = {
  ...
  pricing: {
    overline: 'Pricing',
    headline: 'Priced against the cost of building it yourself.',
    terraWord: 'building it yourself.',
    tagline: 'Five published prices. Every tier includes every capability. No success fees, ever.',
    chips: [
      "What's included free?",
      'Which tier fits me?',
      'Why no success fees?',
      'Let Yulia pick my tier',
    ],
