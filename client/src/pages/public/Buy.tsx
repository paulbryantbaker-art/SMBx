...
const TIMELINE_STEPS = [
  {
    ...
    detail: '\u201CI\u2019m looking for B2B SaaS companies, $1-5M ARR, 70%+ gross margins, in healthcare or fintech.\u201D',
  },
  {
    num: 2,
...
const DEAL_SIZES = [
  {
    range: 'First-time buyer',
    desc: "Buying your first business is terrifying. Yulia makes it methodical.",
    result: '\u201CWent from \u201CI don\u2019t know where to start\u201D to LOI in 6 weeks.\u201D',
  },
  {
    range: 'Search fund / independent sponsor',
    desc: 'Screen hundreds of targets against your thesis. Move fast on the right ones.',
...
const FAQS = [
  {
    ...
    a: 'Market intelligence and public data. We complement brokers, not compete.',
  },
];
    ...
    <PublicLayout>
      ...
      <section className="max-w-site mx-auto px-10 py-20 border-t border-[#E0DCD4] max-md:px-5 max-md:py-12">
        ...
        <h2 className="font-serif text-[clamp(32px,3.5vw,48px)] font-black tracking-[-0.02em] mb-12 m-0">
          From thesis to <em className="italic text-[#DA7756]">closing.</em>
        </h2>
        ...
        <div className="text-center mt-12">
          <p className="text-[15px] text-[#7A766E] mb-5 m-0">
            Typical buy-side journey: <strong className="text-[#1A1A18]">From $1,399</strong>
          </p>
