...
export default function Signup({ onLogin, onGoogleLogin, googleReady, onNavigateLogin }: SignupProps) {
  // Mount the official Google-rendered button once GIS is ready (reliable
  // credential delivery); falls back to the custom button below.
  ...
  useEffect(() => {
    ...
    try {
      google.accounts.id.renderButton(googleBtnRef.current, {
        ...
        text: 'signup_with', shape: 'pill', logo_alignment: 'center', width: 336,
      });
