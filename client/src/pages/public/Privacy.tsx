    ...
    <PublicLayout>
      <section className="max-w-[800px] mx-auto px-10 pt-20 pb-20 max-md:px-5 max-md:pt-12 max-md:pb-12">
        ...
        <div className="space-y-8 text-[15px] text-[#4A4843] leading-[1.7]">
          ...
          <div>
            <h2 className="font-serif text-xl font-bold text-[#1A1A18] mb-3 m-0">What we collect</h2>
            <p className="m-0">
          ...
          <div>
            <h2 className="font-serif text-xl font-bold text-[#1A1A18] mb-3 m-0">How we use it</h2>
            <p className="m-0">
          ...
          <div>
            <h2 className="font-serif text-xl font-bold text-[#1A1A18] mb-3 m-0">Data security</h2>
            <p className="m-0">
          ...
          <div>
            <h2 className="font-serif text-xl font-bold text-[#1A1A18] mb-3 m-0">AI and your data</h2>
            <p className="m-0">
          ...
          <div>
            <h2 className="font-serif text-xl font-bold text-[#1A1A18] mb-3 m-0">Your rights</h2>
            <p className="m-0">
          ...
          <div>
            <h2 className="font-serif text-xl font-bold text-[#1A1A18] mb-3 m-0">Cookies</h2>
            <p className="m-0">
