  ...
  if (loading) {
    return (
      <div className="min-h-dvh bg-[#FFFFFF] flex items-center justify-center">
        <div className="w-6 h-6 border-2 border-[#A03050] border-t-transparent rounded-full" style={{ animation: 'spin 1s linear infinite' }} />
      </div>
    );
  }
      ...
      <header className="bg-white border-b border-[#EBEBEB] px-4 py-3">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="font-bold text-lg text-[#0D0D0D]">smbx<span className="text-[#A03050]">.</span>ai</span>
            <span className="text-xs text-[#6E6A63]">ValueLens</span>
          </div>
          <a
            href="/"
            className="text-sm font-medium text-[#A03050] hover:underline no-underline"
          >
            Get yours free
          </a>
        </div>
