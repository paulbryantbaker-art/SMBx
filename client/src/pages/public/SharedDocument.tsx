      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        {requiresNda && !loading && !error && (
          <div className="max-w-md mx-auto text-center py-8">
            ...
            <h2 className="text-xl font-extrabold text-[#0D0D0D] m-0 mb-2" style={{ fontFamily: "'General Sans', 'Inter', system-ui, sans-serif" }}>
            ...
            <div className="bg-white rounded-2xl border border-border p-5 text-left">
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl text-sm font-semibold bg-[#C96B4F] text-white border-0 cursor-pointer hover:bg-[#BE6342] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        <div className="text-center mt-8">
          <p className="text-xs text-[#A9A49C] m-0">
            Shared via{' '}
            <a href="/" className="text-[#C96B4F] hover:underline">smbx.ai</a>
