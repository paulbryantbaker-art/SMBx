    ...
    <div className="flex h-full bg-[#FAF9F6]">
      ...
      <div className="w-56 shrink-0 bg-white border-r border-[#EBE7DF] p-4">
        <h2 className="text-sm font-bold text-[#0D0D0D] mb-4 flex items-center gap-2">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#BA3C60" strokeWidth="2">
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        <div className="flex items-center justify-between mb-5">
          ...
          {selectedFolder && (
            <label className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-semibold bg-[#BA3C60] text-white cursor-pointer hover:bg-[#BE6342] transition-colors">
            ...
            {folderDocs.length === 0 ? (
              ...
              <div className="space-y-2">
                {folderDocs.map(doc => (
                  <div
                    key={doc.id}
                    className="flex items-center gap-3 bg-white rounded-xl px-4 py-3 border border-[#EBE7DF] hover:border-[#BA3C60]/30 hover:shadow-sm transition-all cursor-pointer"
                  >
