              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex items-end">
                  <button
                    ...
                    className="px-5 py-2 rounded-xl text-sm font-semibold bg-[#C25572] text-white border-0 cursor-pointer hover:bg-[#9E4860] transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                  >
                          ...
                          {overview.cbpData.sizeBreakdown.map((sz: any, i: number) => (
                            <div key={i} className="flex items-center gap-2">
                              ...
                              <div className="flex-1 h-2 bg-[#F5F5F5] rounded-full overflow-hidden">
                                <div className="h-full bg-[#C25572] rounded-full" style={{ width: `${sz.pct || 0}%` }} />
                              </div>
        ...
        {tab === 'reports' && (
          <div>
            {reportsLoading ? (
              ...
              <div className="space-y-3">
                {reports.map(r => (
                  <div key={r.id} className="bg-white rounded-2xl border border-border p-5 hover:border-[#C25572] transition-colors">
