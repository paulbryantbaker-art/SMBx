              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex items-end">
                  <button
                    ...
                    className="px-5 py-2 rounded-xl text-sm font-semibold bg-[#D44A78] text-white border-0 cursor-pointer hover:bg-[#B03860] transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                  >
        ...
        {tab === 'reports' && (
          <div>
            {reportsLoading ? (
              ...
              <div className="space-y-3">
                {reports.map(r => (
                  <div key={r.id} className="bg-white rounded-2xl border border-border p-5 hover:border-[#D44A78] transition-colors">
