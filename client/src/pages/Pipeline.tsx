    ...
    <div className="min-h-dvh bg-[#FAFAFA]">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-[#FAFAFA]" style={{ borderBottom: '1px solid rgba(0,0,0,0.08)' }}>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={onLogout}
            className="text-sm text-[#A9A49C] bg-transparent border-0 cursor-pointer hover:text-[#B5636B] transition-colors"
          >
            Sign out
          </button>
        </div>
          ...
          {deals.map(deal => {
            ...
            return (
              <button
                ...
                className="w-full text-left bg-white rounded-2xl p-5 border border-border hover:border-[#B5636B] hover:shadow-sm transition-all cursor-pointer"
              >
                {/* Header */}
                <div className="flex items-center gap-3 mb-3">
