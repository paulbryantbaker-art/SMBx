...
export const SURFACE_ACTIONS = {
  ...
  run_recast_analysis: {
    id: "run_recast_analysis",
    label: "Run Recast Analysis",
    kind: "analysis",
    result: "analysis_canvas",
    backendTool: "run_analysis",
    analysisType: "recast",
    requiresDeal: true,
    description: "Create or open a recast and normalization analysis canvas.",
  },
  ...
  run_sba_analysis: {
    id: "run_sba_analysis",
    label: "Run SBA Analysis",
    kind: "analysis",
    result: "analysis_canvas",
    backendTool: "run_analysis",
    analysisType: "sba",
    requiresDeal: true,
    description: "Create or open an SBA bankability and leverage scenario canvas.",
  },
  ...
  run_qoe_analysis: {
    id: "run_qoe_analysis",
    label: "Run QoE Analysis",
    kind: "analysis",
    result: "analysis_canvas",
    backendTool: "run_analysis",
    analysisType: "qoe",
    requiresDeal: true,
    description: "Create or open a quality-of-earnings canvas with add-back, revenue quality, and evidence checks.",
  },
  run_lbo_analysis: {
    id: "run_lbo_analysis",
    label: "Run LBO Model",
    ...
    analysisType: "lbo",
    requiresDeal: true,
    description: "Create or open an LBO model canvas with leverage, exit, MOIC, and IRR scenarios.",
  },
  run_dcf_analysis: {
    id: "run_dcf_analysis",
    label: "Run DCF Model",
    ...
    analysisType: "dcf",
    requiresDeal: true,
    description: "Create or open a DCF canvas with growth, margin, WACC, terminal value, and FCF assumptions.",
  },
  run_sensitivity_analysis: {
    id: "run_sensitivity_analysis",
    label: "Run Sensitivity Model",
    kind: "analysis",
    result: "analysis_canvas",
    backendTool: "run_analysis",
    analysisType: "sensitivity",
    requiresDeal: true,
    description: "Create or open a scenario sensitivity canvas for value, margin, and multiple changes.",
  },
  run_earnout_analysis: {
    id: "run_earnout_analysis",
    label: "Run Earnout Model",
    kind: "analysis",
    result: "analysis_canvas",
    backendTool: "run_analysis",
    analysisType: "earnout",
    requiresDeal: true,
    description: "Create or open an earnout canvas with probability-weighted value, timing, and structure issues.",
  },
  run_tax_impact_analysis: {
    id: "run_tax_impact_analysis",
    label: "Run Tax Impact Model",
    kind: "analysis",
    result: "analysis_canvas",
    backendTool: "run_analysis",
    analysisType: "tax_impact",
    requiresDeal: true,
    description: "Create or open a tax impact model for structure, allocation, and tax sign-off issues.",
  },
  run_purchase_price_allocation: {
    id: "run_purchase_price_allocation",
    label: "Run Purchase-Price Allocation",
    kind: "analysis",
    result: "analysis_canvas",
    backendTool: "run_analysis",
    analysisType: "purchase_price_allocation",
    requiresDeal: true,
    description: "Create or open an allocation canvas for goodwill, equipment, inventory, and state/tax review.",
  },
  run_cap_table_analysis: {
    id: "run_cap_table_analysis",
    label: "Run Cap Table Model",
    kind: "analysis",
    result: "analysis_canvas",
    backendTool: "run_analysis",
    analysisType: "cap_table",
    requiresDeal: true,
    description: "Create or open a cap table model for dilution, option pool, and liquidation preference scenarios.",
  },
  run_covenant_analysis: {
    id: "run_covenant_analysis",
    label: "Run Covenant Model",
    kind: "analysis",
    result: "analysis_canvas",
    backendTool: "run_analysis",
    analysisType: "covenant",
    requiresDeal: true,
    description: "Create or open a covenant model for DSCR, leverage, loan-to-value, and lender pressure.",
  },
    compare_deals: {
    id: "compare_deals",
    label: "Compare Deals",
