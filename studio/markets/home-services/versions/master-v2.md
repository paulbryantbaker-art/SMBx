...
headshot: brand/founder-portrait.jpg
image: home-services-cover.jpg
imagePos: 50% 50%
footer: Home Services M&A — Master Market Assessment
eyebrow: MARKET ASSESSMENT
stat: ~89% | Plumbing/HVAC shops under 20 staff
stat: 39 of 77 | PE share of tracked HVAC deals, 2026 YTD
stat: 4–8x → 16–20x | Add-on vs. platform
stat: ~111K | NAICS 238220 establishments
stat: 550K | Projected plumber shortfall by 2027
stat: 2.1M | Unfilled skilled trades by 2030
-->
# Home Services M&A
...
- **The market is structurally fragmented — and the fragmentation, not the aggregate size, is the thesis.** ~89% of the ~111,000 combined NAICS 238220 (plumbing/HVAC) establishments have fewer than 20 employees and remain independent; 76% of critical-trade operators are still true independents (McKinsey); no single entity commands 20% share in any major vertical, and in plumbing no company holds above ~2% national share. **A combined six-trade revenue total is deliberately NOT stated in this document** — see A.0.2. The individually sourced trade figures are HVAC $158.4B (2025) and $159.4B (2026), plumbing $191.4B (2026), roofing $92.5B (2026), pest control $29.7B (2026), garage doors $16.0B — all IBISWorld except garage doors (FMI). Electrical has no defensible trade-scope figure and is therefore carried without a dollar value. Summing figures drawn from different definitions, vintages and scopes would manufacture a number no source reports.

- **PE now takes roughly half of tracked HVAC deal flow, and the top of the market re-priced hard in 2024–2026.** Capstone Partners data cited by S&P Global counts **39 of 77 tracked HVAC transactions going to PE through early June 2026**; Capstone's own July 17, 2026 update reports **92 transactions YTD 2026, 47 of them PE**. Separately and on a different basis, Axial reports PE at **8% of HVAC deals within Axial's marketplace in 2023, rising to 23% in 2024** — an Axial-universe figure that must not be spliced to Capstone's tracked universe as a single trend line. Five platform recaps between Nov 2024 and May 2026 carry **combined reported valuations of roughly $16B** (sum of the five reported values below; not a figure any source states): **Apex ~$10B incl. debt (Apollo minority, May 2026), Champions ~$2.5B (Blackstone, Feb 2026), Sila ~$1.7B (Goldman, Nov 2024), Redwood ~$1.1B (Altas, May 2025), Guild Garage >$800M (Oak Hill, Mar 2026)** — plus Service Logic to Bain/Mubadala (Dec 2025, **no enterprise value ever disclosed**). **Every one of these five is an anonymous-source trade-press figure** ("people familiar with the matter"; financials explicitly confidential; no party disclosed terms). They carry "reportedly" wherever they appear — see A.2.
...
Private-equity dry powder reached a record **$2.62 trillion as of H1 2024** — a figure published by **S&P Global Market Intelligence (July 12, 2024)** covering private equity *and* venture capital, not Bain. Bain's separate buyout-only measure **fell from $1.3 trillion to $1.2 trillion over 2024** (Global PE Report 2025), and Bain's midyear-2025 read puts global buyout dry powder at **$1.2 trillion**. **No source segments any portion of that capital to "essential services" or to home services** — a prior version of this document asserted "$1.2 trillion actively hunting essential-services assets," which was the all-sector buyout total relabeled. That claim is retired; see A.0.2. With SOFR in the low-4% range through mid-2026 and public software valuations volatile, institutional capital has rotated toward infrastructure-like assets with stable, long-duration cash flows — and home services fits the mandate flawlessly:
...
- **Combined NAICS 238220 (Census):** the 2022 Economic Census (table **EC2223BASIC**) does publish receipts for construction NAICS codes, and the 238220 row returns **$267.1B** for receipts-for-construction-work (`RCPCWRK`) against **$297.6B** for total revenue (`RCPTOT`). The **~$392B previously carried here is not in the table** — it traces verbatim to VantaInsights, a commercial aggregator citing "Census Bureau" with no table ID and no year. The $267.1B figure was validated by exact parent-child summation at three levels (Electrical $230.78B + Plumbing/HVAC $267.13B + Other Building Equipment $39.78B = Building Equipment Contractors $537.68B exactly, which rolls up exactly to Specialty Trade $1,131.22B and Construction $2,239.54B). **Pull the exact cell from data.census.gov before publishing either value.** The establishment count of ~111,200 and the 1.21M-worker figure were likewise not reproduced from the API (the 238220 row returned 112,088 on a firm-count basis and 1,690,333 on the employment column) — treat ~111K as approximate and unconfirmed. Three scope labels travel with whichever value is used: it is **combined** (one code, two trades), **employer-only**, and **total-market**, not residential.
...
|---|---|---|---|---|---|
| Electrical | **no defensible figure** (see note) | ~79,611 employer firms | Grid, EV, AI data centers | Multi-year commercial backlogs | **Residential: early** |
...
| Pest control | $29.7B (IBISWorld) / $13.416B (NPMA) | ~33,000 | Hygiene, infestations | Highest recurring revenue (85.4% residential) | Late (oligopoly) |
...
- **Electrical** carries **no dollar figure in this document.** IBISWorld's "Electricians" report ($347.5B, 2026) includes low-voltage, data cabling, telecom and fire/security — the wrong scope for a trades TAM, which is why it was retired on 2026-07-26. But the ~$235B (2022) / ~$265–280B (2026) that replaced it **has no source either**; the closest published series is Arizton's U.S. electrical contractors market at $237.59B (2023) → $256.65B (2029), and NECA's 2024 Profile publishes no aggregate industry revenue. Until a primary-source trade-scope figure is found, electrical is carried qualitatively. The qualitative case is strong and independently sourced: Goldman projects U.S. data-center power demand more than doubling from 31 GW (2025) to 66 GW (2027); electrical is 45–70% of data-center construction cost. Data-center/healthcare capability commands a 1–2 turn premium; MYR Group paid $328M for two regional commercial contractors in late 2025; the top-50 electrical contractors consolidated a record $59.5B revenue in 2025.
- **Pest control** is the high-multiple standard: **85.4% of U.S. residential pest service revenue was recurring in 2025** (up from 85.2% in 2024) per Specialty Consultants LLC via NPMA — the scope label matters, it is *residential service revenue*, not all pest revenue, and the "74%" carried in prior versions had no source at all. Independents trade 6–10x, consolidated by a global oligopoly (**Rentokil Initial revenue $6.9B in 2025, +3.8%, of which North America $4.3B, +3.2%** — the "~$6.8B" in prior versions was off, and if the intent was the Terminix/North America business the number is $4.3B; **Rollins $3.761B FY2025 with 26 acquisitions**, EQT-backed Anticimex) — but 33,000 independents remain, and rising compliance/software burden accelerates their willingness to sell. **Market size is itself contested:** IBISWorld $29.7B (2026) vs. Specialty Consultants/NPMA $13.416B (2025 U.S. structural pest control service revenue, +6% on 2024's $12.654B). Both are stated; no midpoint.
- **Garage doors** is "PE's next HVAC": non-cyclical breakdown demand, DIY-proof (spring injuries), validated by Guild Garage (self-funded $35M in 2024 → 25–30 tuck-ins → reported >$300M revenue → **Oak Hill at "more than $800 million" per Reuters, March 6 2026, citing four people familiar with the matter; PitchBook separately puts the value at $800M on a 16x EBITDA multiple, per PitchBook data**. The ~$50M EBITDA carried in prior versions is an arithmetic derivation of $800M ÷ 16x — no source publishes it) and by KKR's C.H.I. Overhead Doors 9.8x return (2015–2022).
...
- **Deal flow (two separate datasets — do not splice them):** *Axial's marketplace:* PE at **8% of HVAC deals within Axial in 2023 → 23% in 2024**. *Capstone's tracked universe:* **39 of 77 HVAC transactions to PE through early June 2026** (Capstone data cited by S&P Global), and **92 transactions YTD with 47 to PE** in Capstone's July 17, 2026 update. The "50.6% in H1 2025" carried in prior versions mis-dated the 39-of-77 figure by a full year and welded it to an Axial-universe baseline. S&P Global separately reports PE add-ons targeting HVAC services up 88% YoY through June (32 vs. 17). Capstone's Dec 5, 2025 update counts **149 HVAC-services transactions announced or completed, +12.9% YoY** — stated by Capstone as year-to-date at that publication date, not audited full-year. **The "broader industrial M&A fell 24.6%" comparison is retired:** Capstone's own page says only that Industrials M&A "declined during the same period," with no figure; the 24.6% appears solely in a trade blog and could not be found in any Capstone or S&P publication.
...
**Implication:** The tuck-in universe is enormous (~97,000 sub-20-employee shops) but the platform/large-add-on universe that moves the needle is scarce and increasingly picked over — which is exactly why add-on multiples hold firm even as platform multiples face rate pressure.
...
|---|---|---|---|---|---|---|---|
| **Apex Service Partners** | Alpine Investors + Partners Group; Apollo minority | Apollo ~$2B minority at **"$10 billion, including debt"** (Reuters, May 28 2026, citing sources familiar); $3.4B continuation Q4 2023; ~60 add-ons in 2025 | 75–107 (46 states) | **7,800 tradespeople (Reuters) vs. 13,000 people (company/trade) — conflict** | "more than $3 billion" rev / "over $500 million" EBITDA | **~$10B; ~20x is DERIVED** | **Anonymous-source; terms not disclosed in the official May 28 announcement** |
| **Service Logic** (commercial-lean) | Bain Capital + Mubadala (closed Dec 16 2025) | Recap from Leonard Green | 50+ / 140+ locations | 5,000+ techs | **$2.2B+ (2024, disclosed)** | **NO EV EVER DISCLOSED** | The "$3.1B" is a **debt financing package** (Bloomberg, Nov 4 2025), not an enterprise value; "$4.1B" has no source — see A.0.2 |
...
| **Guild Garage Group** | Oak Hill Capital (Mar 2026) | **"more than $800 million"** (Reuters, Mar 6 2026, four people familiar); PitchBook: $800M at **16x, per PitchBook data**; ~29–30 acquisitions since 2024 | 28–30 | 500+ techs | >$300M | **>$800M / 16x** | Reuters anonymous-source on value; **16x is PitchBook-published**; ~$50M EBITDA is derived, unpublished |
...
- **Pest oligopoly (adjacency reference):** Rentokil Initial (**$6.9B 2025 revenue, +3.8%; North America $4.3B, +3.2%** — 2025 Preliminary Results, Mar 5 2026), Rollins (**$3,761,050 thousand = $3.761B FY2025**, 26 acquisitions, $310M invested — 10-K filed Feb 12 2026), Anticimex (EQT, 3M+ customers).
...
| NAICS 238220 revenue | "~$392B (2022 Economic Census EC2223BASIC)" | **$267.1B (RCPCWRK) or $297.6B (RCPTOT); pull the exact cell before publishing** | $392B is not in the table. It traces verbatim to VantaInsights, a commercial aggregator citing "Census Bureau" with no table ID or year. The 2026-07-26 pass corrected this figure's *citation* while leaving its *value* wrong. |
| Electrical trade size | "~$235B (2022) / ~$265–280B (2026)" | **No figure carried** | The replacement figure was as unsourced as the one it replaced. Published alternatives are IBISWorld $347.5B (wrong scope — includes low-voltage/telecom) and Arizton $237.59B (2023) → $256.65B (2029). |
...
| PE share of HVAC deals | "8% (2023) → 50.6% (H1 2025)" | **Two datasets, stated separately** — Axial: 8% (2023) → 23% (2024) *within Axial*; Capstone: 39 of 77 through **early June 2026**, and 92 YTD / 47 PE as of Jul 17 2026 | The 39-of-77 figure was mis-dated by a full year, and splicing an Axial-marketplace baseline to Capstone's tracked universe produced a trend no single dataset supports. |
...
**Verified clean and unchanged:** all BLS labor figures (425,200 HVAC / 40,100 openings / $59,810 median; 504,500 plumbers / 44,000 openings / $62,970 median); JLL's 2.1M unfilled skilled-trades positions by 2030 (Apr 21 2026 — note the accompanying $1T loss figure is attributed by JLL to the U.S. Department of Education, not to JLL); the LIXIL/John Dunham & Associates 550,000 plumbing shortfall by 2027; HVAC $158.4B (2025) / $159.4B (2026); plumbing $191.4B (2026) with the $121.5B conflict genuine and both retained; roofing $92.5B (2026); garage doors $16.0B (FMI); Rollins $3.761B and 26 acquisitions.

The consolidated successor to this document is the Home Services market master in Studio.
...
| **Apex headcount** | Reuters "more than 7,800 tradespeople" vs. company/trade "more than 13,000 people". | Both stated. The figures likely count different populations (field tradespeople vs. total employees); neither is discarded. |
...
U.S. Census 2022 Economic Census table EC2223BASIC and the Census data API (RCPTOT / RCPCWRK variable metadata); Census CBP/SUSB (NAICS 238220); BLS OOH/OES (SOC 49-9021, 47-2152); S&P Global Market Intelligence dry-powder series (Jul 12 2024); Bain Global PE Report 2025 and midyear 2025; Reuters (Apex, May 28 2026; Guild Garage, Mar 6 2026); Bloomberg (Service Logic financing, Nov 4 2025); PitchBook (Guild Garage multiple); HomePros (Champions, Sila, Redwood); JLL Newsroom (Apr 21 2026); LIXIL / John Dunham & Associates, Journal of Applied Business and Economics Vol. 26(3) 2024; NPMA / Specialty Consultants LLC (Apr 1 2026); Rollins FY2025 10-K (Feb 12 2026); Rentokil Initial 2025 Preliminary Results (Mar 5 2026); Arizton U.S. electrical contractors market; IBISWorld; Capstone Partners; Axial; S&P Global Market Intelligence; GF Data; Grata; McKinsey home-services research; Bain Global PE Reports; Reuters/Bloomberg/Homepros deal coverage; ACHR News; Contracting Business; HARDI EPA filings; SearchLight Digital CPL benchmark (Jan 2026); WTW insurance projections; RMI/AHRI heat-pump shipment data; platform websites and sponsor press releases; PE trackers (CT Acquisitions, Pipeline On, PitchBook, CB Insights, Craft Dossier).

---

## Sources

Every figure in this master traces to one of the two documents in `research/`, or is registered under `## Derivations` below.

| Source document | What it carries |
|---|---|
| `home-services-master-assessment` | The consolidated read from three commissioned research workstreams — TAM/SAM/SOM, consolidation state, the platform map, regionality, labor, regulatory, operating economics, integration playbook. Pre-correction; the errors it carries are registered in A.0.2. |
| `verification-pass-2026-07-27` | The primary-source evidence trail. Every corrected figure, quoted as its source states it, with the URL and publication date. This is the document that overturned the six unsourced figures. |

### Source URLs carried through from `verification-pass-2026-07-27`
...
|---|---|---|---|
| **~$16 billion** — combined reported valuations of the five platform recaps, Nov 2024 – May 2026 | Apex $10 billion (Reuters) + Champions $2.5 billion + Sila $1.7 billion + Redwood $1.1 billion + Guild $0.8 billion | Sum = $16.1 billion, stated as ~$16 billion | That summing five separately-reported transaction valuations is meaningful. It is a headline convenience, not a market measure: the Apex figure is a whole-company valuation attached to a *minority* investment and includes debt, the others are enterprise values on control transactions, and all five are anonymous-source figures. Service Logic is excluded because no EV was ever disclosed. **Do not present this as a market total.** |
| **~20x** — Apex implied multiple | $10 billion valuation ÷ "over $500 million" EBITDA (both Reuters, both anonymous-source) | $10B ÷ $500M ≤ 20x | That the reported EBITDA is the denominator the $10B was struck against. No source publishes an Apex multiple. Flagged as derived wherever it appears. |
| **~$50 million** — Guild Garage EBITDA | $800 million valuation (Reuters/PitchBook) ÷ 16x (PitchBook) | $800M ÷ 16 = $50M | That PitchBook's 16x was computed against the same $800M. No source publishes a Guild EBITDA figure. **Retired from the body of this document**; recorded here only so the number is recognisable if it resurfaces. |

*Document generated July 2026; corrected 2026-07-26 (TAM reconciliation) and 2026-07-27 (primary-source verification pass — see A.0.2). Consolidates three research reports commissioned for smbX.ai home-services vertical strategy. Estimated figures should be re-verified at engagement time; platform ownership and brand rosters change monthly in this market.*

*Source of record for this master: `research/home-services-master-assessment.md` (the pre-correction consolidation) plus the 2026-07-27 verification pass. Every correction in A.0.2 names the source that overturned the figure.*
