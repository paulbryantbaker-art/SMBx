...
| 6 | Tier-0 Server Models | 🟡 Executable set now covers SDE, EBITDA, valuation triangulation, DSCR stress, NWC peg, sources/uses, SBA, HSR, QoE Lite, tax structure, legal halt scan, LBO LMM, PPA, rollover, earnout, and structure analysis. `npm run test:v19-models` covers 14 deterministic fixtures. | Replace remaining generic ranking/context models (`BUYER.FIT`, `DEAL.SCORE`, `MARKET.CONTEXT`, sensitivity, comparison, covenant, DCF, PMI) with full calculations. |
