...
5. Grow conformance cases from 214 toward 240 across prompt behavior, route-trigger behavior, deal-mechanics route profiles, and meta behavior.
6. Add authenticated route-level smoke tests for Studio export packet retrieval, model-backed chat packet retrieval, THE LINE refusals, and staged approval behavior now that the DB/JWT fixture exists.
