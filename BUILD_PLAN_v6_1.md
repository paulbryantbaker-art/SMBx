...
**SBA Bankability Analysis (dock tool #4 + buy journey core feature):**
...
- [ ] Seller note standby modeling: full standby for entire loan term (June 2025 rule)
...
| B | Gates + Scoring + Docs | Week 1-2 | ~20 hrs | 22 gates, seven-factor model, doc upload/parsing, SBA analysis, auth |
| C | Wallet + Stripe + Paywall | Week 2-3 | ~16 hrs | Payment system, menu pricing, paywall at S2/B2/R2 |
| D | Deliverables + Worker | Week 3-4 | ~16 hrs | pg-boss worker service, AI generation pipeline, PDF/XLSX export |
...
| G | Market Watch + Data Pipeline | Month 2 | ~24 hrs | LangGraph.js agents on existing worker, gov data APIs, engagement tiering, daily briefings |
...
**Total to launch**: ~76 hours (~5 weeks)
