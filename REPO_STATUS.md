...
### Design system — Atlas app + Ramp marketing (June 2026); retool pending
...
- `SMBX_PRICING_STRATEGY_AND_RECOMMENDATION.md` (May 3, 2026) plus the May 21 hybrid MCP pricing memo — V19/DEFINITIVE monthly subscription model: Free / $99 Solo / $249 Pro / $749 Team / $3,000+ Enterprise, with legacy $79 / $199 / $499 / $2,500+ treated as early-access or annual-equivalent only.
- `THE_LINE_POLICY.md` — current hard operating policy for pricing, artifact, marketing, and Yulia behavior boundaries.
...
- `server/services/definitiveConnectorDistribution.ts` — Claude-first connector launch package and reusable marketplace evidence pack
...
Archived files live in `docs/_archive/`. Historical Claude Design handoffs also live under `client/src/components/claude_design/`; that folder is excluded from TypeScript compilation and has a local README warning that it is not a source of truth. Each archived markdown also carries an in-file banner. See `docs/_archive/README.md` for the full timeline.
...
1. **Does it predate the Atlas cutover (June 24, 2026) and talk about the design system or marketing surface?** → Probably stale. Atlas redesigned the app; Ramp reskinned marketing; a further retool is pending (`UI_RETOOL_READINESS.md`).
2. **Does it talk about pricing without mentioning monthly subscriptions (Free / $99 Solo / $249 Pro / $749 Team / $3,000+ Enterprise)?** → Stale. The wallet model is dead; do not recreate. Legacy $79 / $199 / $499 / $2,500+ references are early-access or annual-equivalent only.
...
4. **Does it treat V6 slate-blue/lavender/periwinkle as live, or use Cowork DL (warm cream + clay), V4 hot pink `#D44A78`, or V3 indigo+emerald palettes?** → Stale design language. Current: Atlas (app) + Ramp (marketing), retool pending.
