...
Tier 4: deal_size > $15M → Senior bank + private credit/mezzanine + PE equity
Tier 5: buyer_credit < 690 OR limited collateral → ROBS + heavy seller financing + earnout
Equity injection sources (priority): cash savings → HELOC → ROBS → investor equity
```
